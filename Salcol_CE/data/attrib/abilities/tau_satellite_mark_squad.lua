...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$665856]] -- - Marked units become more vulnerable to fire from all Tau units.
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Left-Click any enemy entity or squad to mark them.]]
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_mark_target_icon]]
GameData["ui_info"]["screen_name_id"] = [[High Priority Target]]
