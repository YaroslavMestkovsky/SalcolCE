...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["probability_of_applying"] = 0.349999994
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["max_lifetime"] = 25
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["max_lifetime"] = 25
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["modifier"] = Reference([[modifiers\keen_sight_radius_modifier.lua]])
...
GameData["child_ability_name"] = [[inquisition_wargear_brotherhood_champion_5_2]]
...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_wargear_brotherhood_champion_5.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow psyk-out grenades to be thrown.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Upon landing, they will sever any connection with the warp energies, causing terrible mental damage.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Sometimes, the body of anyone within the area of effect will also take severe damage]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Basic infantry will suffer a long stun effect, while anyone else will lose the possibility to cast spells or use skills]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[Monsters and lesser daemons will most probably be banished from Realspace, while greater daemons will be weakened dramatically]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/hero_exterminatus_ability.tga]]
GameData["ui_info"]["screen_name_id"] = [[Psyk-out grenades]]
