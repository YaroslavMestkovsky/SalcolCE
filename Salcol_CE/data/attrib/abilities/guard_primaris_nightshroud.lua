...
GameData["ability_ordered_event_mp"] = [[guard/abilities/nightshroud]]
GameData["ability_ordered_event_name"] = [[guard/abilities/nightshroud]]
...
GameData["ui_hotkey_name"] = [[guard_primaris_psyker_nightshroud]]
GameData["ui_index_hint"] = 2
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$92301]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- A unatural mist sets over the battlefield, seemingly both obscuring and protecting the psykers allies.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Reduces ranged damage taken by allies in the area by 40%]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Lasts 30 seconds]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["icon_name"] = [[guard_icons/nightshroud_icon]]
GameData["ui_info"]["screen_name_id"] = [[Nightshroud]]
