...
GameData["ui_hotkey_name"] = [[injection_splintermind_drug]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Splintermind injections have the purpose of attenuating the feeling of fear]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Increase the morale damage resistence of the user squad]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Also increase morale recovery for the whole duration]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[- Lasts for 15 seconds]]
GameData["ui_info"]["help_text_list"]["text_07"] = [[$4100010]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/drug_splintermind]]
GameData["ui_info"]["screen_name_id"] = [[Injection: Splintermind Drug]]
