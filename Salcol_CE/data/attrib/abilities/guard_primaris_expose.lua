...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[guard/abilities/expose]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[guard/abilities/expose]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[guard/abilities/expose]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[guard/abilities/expose]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[guard/abilities/expose]]
...
GameData["ui_hotkey_name"] = [[guard_primaris_psyker_expose]]
GameData["ui_index_hint"] = 4
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$91551]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The psyker breaks through barriers and other protective measures of the target.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Removes any positive and negative modifiers to damage taken from the target.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Recommended to be used against units under the influence of damage resistance.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["icon_name"] = [[guard_icons/expose_icon]]
GameData["ui_info"]["screen_name_id"] = [[Expose]]
