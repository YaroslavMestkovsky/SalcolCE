...
GameData["ui_hotkey_name"] = [[eldar_wraithguard_wraithbone_regeneration]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18112258]] -- - Built in ability systems encase the user in wraithbone.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18112259]] -- - If turned on, the user will regenerate 30 health per second.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18112260]] -- - However, movement speed and attack rates are halved for the whole duration
