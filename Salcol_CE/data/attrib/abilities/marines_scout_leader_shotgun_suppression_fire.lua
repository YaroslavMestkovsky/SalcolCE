...
GameData["area_effect"]["area_effect_information"]["angle_left"] = -35
GameData["area_effect"]["area_effect_information"]["angle_right"] = 35
...
GameData["area_effect"]["throw_data"]["up_angle_min"] = 4
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Overwhelm enemies with a huge amount of bullets]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Although dealt damage is low, enemy speed in the area is reduced]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Low range ability used to buy time]]
GameData["ui_info"]["icon_name"] = [[space_marine_icons/rangeincrease_research]]
GameData["ui_info"]["screen_name_id"] = [[Suppression fire]]
