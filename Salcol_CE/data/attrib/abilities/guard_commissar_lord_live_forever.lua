...
GameData["ui_hotkey_name"] = [[guard_commissar_want_live_forever]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Truly great commissars do not need their sidearm to remind their men of their duties]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- A zealous speech makes all nearby soldiers fight without relenting]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Makes all nearby squads immune to morale damage for 30 seconds]]
GameData["ui_info"]["icon_name"] = [[guard_icons/live_for_ever_icon]]
GameData["ui_info"]["screen_name_id"] = [[Do You Want To Live Forever?]]
