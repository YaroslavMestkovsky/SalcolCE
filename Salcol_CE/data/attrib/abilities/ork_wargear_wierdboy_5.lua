...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_03"] = Reference([[type_armour\tp_living_metal.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_03"]["screen_name_id"] = [[$4450037]] -- Aircraft
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_04"] = Reference([[type_armour\tp_building_high.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_05"] = Reference([[type_armour\tp_building_super.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_05"]["screen_name_id"] = [[$4450037]] -- Aircraft
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_13"]["armour_type"] = Reference([[type_armour\tp_living_metal.lua]])
...
GameData["child_ability_name"] = [[ork_wargear_wierdboy_5_child_2]]
...
GameData["requirements"]["required_1"]["research_name"] = [[research\ork_wargear_wierdboy_5.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This frazzle only harms buildings by corroding their walls in a cone shape from the wierdboy.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[slow and inesorable health degeneration will be applied for a very long time.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Damage applied will depend on the armor level of the affected buildings.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["icon_name"] = [[ork_icons/wierdboy_frazzle]]
GameData["ui_info"]["screen_name_id"] = [[Corrosive frazzle]]
