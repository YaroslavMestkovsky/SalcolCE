...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[chaos/delightful_agonies]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[chaos/delightful_agonies]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[chaos/delightful_agonies]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[chaos/delightful_agonies]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[chaos/delightful_agonies]]
...
GameData["ui_hotkey_name"] = [[chaos_delightful_agonies]]
GameData["ui_index_hint"] = 4
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$91551]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Pain only spurs the scions of Slaanesh to greater heights]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The target squad gains 75% resistance to damage for 20 seconds]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_cold_anger]]
GameData["ui_info"]["screen_name_id"] = [[Delightful Agonies]]
