...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$694552]] -- - Executing a unit frightens nearby infantry into never yelding to fear.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$694553]] -- - Infantry in a 20m radius will become very resilient to morale damages taken from ranged attacks for 10 seconds
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Applies the following bonuses:]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- +20% melee morale resilience]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[- +50% ranged morale resilience]]
GameData["ui_info"]["help_text_list"]["text_07"] = [[- Double squad morale regeneration]]
