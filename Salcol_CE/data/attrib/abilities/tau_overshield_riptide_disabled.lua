...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Force the shield to go up as a last stand defense system]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Should be used only in case of emergency]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Prevents incoming damages for 8 seconds at a heavy power cost and prevents any other action in the mean time]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$666102]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_overshield_riptide_icon3]]
GameData["ui_info"]["screen_name_id"] = [[Emergency Overcharged Shield]]
