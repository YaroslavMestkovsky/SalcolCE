...
GameData["requirements"]["required_2"]["research_name"] = [[research\dark_eldar_fleet_of_foot_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210404]] -- - Increases movement speed by 50% in exchange for weapon accuracy. 
