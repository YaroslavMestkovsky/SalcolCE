...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_18"]["armour_piercing_value"] = 70
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\armour_minimum_modifier.lua]])
...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_guard_wargear_vindicare_assassin_bullet_turbo_penetrator.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Slight setup time and outrageous damage against armored targets]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Also degenerates the enemy armour for 10 seconds]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Vindicare Assassins are entrusted with only one of these bullets per mission]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Can only target infantry squads, commanders and vehicles]]
...
GameData["ui_info"]["icon_name"] = [[guard_icons/vindicare_bullet_turbo_penetrator_ability]]
