...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[guard/abilities/rally_red]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[guard/abilities/rally_red]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[guard/abilities/rally_red]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[guard/abilities/rally_red]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[guard/abilities/rally_red]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["surface"] = Reference([[type_surface\tp_monolith.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\enable_hardpoint_04.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 0.3300000131
...
GameData["ui_hotkey_name"] = [[guard_commissar_leave_by_example]]
GameData["ui_index_hint"] = 3
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- No foe is too grim, no challenge great, no heretic too powerful]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- filled with righteous determination, the commissar is slowed down while gaining 66% ranged damage resistance]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- The commissars attacks also inflict heavy AOE damage and knockback for the duration]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Lasts for 25 seconds]]
GameData["ui_info"]["icon_name"] = [[guard_icons/raeg]]
GameData["ui_info"]["screen_name_id"] = [[Lead By Example]]
