...
GameData["requirements"]["required_1"]["research_name"] = [[research\dark_eldar_wargear08.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Much stronger tactical grenade]]
