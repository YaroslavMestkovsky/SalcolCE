...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Completely block health regeneration in exchange for attack speed]]
...
GameData["ui_info"]["screen_name_id"] = [[Insatiable fury]]
