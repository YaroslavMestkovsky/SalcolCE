...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Distract an enemy squad, preventing them from efficiently protecting against attacks]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Works on monsters and daemons too]]
