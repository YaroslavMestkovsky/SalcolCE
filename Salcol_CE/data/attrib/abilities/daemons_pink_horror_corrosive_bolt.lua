...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This attack can only affect vehicles and has a chance to immobilize them or prevent them from attacking]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also causes overtime damages and armour reduction]]
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_incarcerator_horror_torture_icon_on.tga]]
