...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[inquisition\strip_soul]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[inquisition\strip_soul]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[inquisition\strip_soul]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[inquisition\strip_soul]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[inquisition\strip_soul]]
...
GameData["ui_hotkey_name"] = [[inquisition_lord_purge_soul]]
GameData["ui_index_hint"] = 2
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$92411]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The Inquisitor channels his power to smite down a single target.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Deals very high damage to a single target, particularly commanders.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Also depletes the casters morale.]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons\Purge_Soul_icon]]
GameData["ui_info"]["screen_name_id"] = [[Purge Soul]]
