...
GameData["requirements"]["required_1"]["research_name"] = [[research\daemons_wargear_herald_of_tzeentch_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allows the vision of the whole map for a short period of time.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Infiltrated units and shrouded buildings will be revealed as well for the whole duration]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_tzeentch_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Blessing of the architect of faith]]
