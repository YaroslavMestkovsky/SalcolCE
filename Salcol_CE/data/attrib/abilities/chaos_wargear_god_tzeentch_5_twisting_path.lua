...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"]["value"] = 50
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Unlock a spell that allows the sorcerer to manipulate his enemy's mind,  causing an unsettling waking dream in which they ally themselves with the Dark Powers.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[During this time their foe is temporarily stunned and the sorcerer is able to retrieve information from their mind, implant post-hypnotic suggestions and alter memories.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_kinetic_whirlwind_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Twisting Path]]
