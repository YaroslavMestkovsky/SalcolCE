...
GameData["child_ability_name"] = [[sisters_supreme_laud_hailers_e1]]
...
GameData["requirements"]["required_1"]["min_health_fraction"] = 0.8500000238
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[Requires 85% health to operate]]
