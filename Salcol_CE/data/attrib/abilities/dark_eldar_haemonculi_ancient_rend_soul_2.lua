...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 125
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\ability_crucible_event.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\dark_eldar_research_rend_soul_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The power of 3000 souls will invest a single target or squad]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Although the immediate physical damage isn't severe, the mental state of the target will be compromised beyond recovery]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- if used on a squad, they'll start attacking everything they see and in the meantime a slow and inesorable physical deterioration will take place]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- On a vehicle, the effect is exactly the same.]]
...
GameData["ui_info"]["screen_name_id"] = [[Rend soul]]
