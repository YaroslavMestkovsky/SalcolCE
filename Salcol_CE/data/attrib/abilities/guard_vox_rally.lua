...
GameData["ui_hotkey_name"] = [[guard_vox_operator_rally]]
GameData["ui_index_hint"] = 5
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The Vox Operator announces new reinforcements are arriving, giving new faith to soldiers on the frontline]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[$91574]] -- - Greatly improves morale damage resistence within 20m.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$91575]] -- - Also bolsters morale recovery rate for the whole duration.
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Lasts for 10 seconds]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[$91573]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[guard_icons\rally]]
