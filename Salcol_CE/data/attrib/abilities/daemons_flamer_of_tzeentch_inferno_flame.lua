...
GameData["child_ability_name"] = [[daemons_flamer_of_tzeentch_inferno_flame_2]]
GameData["child_activation_percent"] = 0.1000000015
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Flamer of Tzeentch focuses his attack right into the ground opening a way into stone and dirt alike]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Flames will emerge some meters afar and engulf anyone in the proximity]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Very rarely a gas deposit or other underground inflammable resources can suddenly blow up causing extreme damages and knockback within a large offset from the designated spot]]
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_let_it_burn_icon]]
GameData["ui_info"]["screen_name_id"] = [[Inferno flame]]
