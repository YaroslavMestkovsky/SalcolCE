...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\morale_rate_squad_modifier.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["modifier"] = Reference([[modifiers\ability_souless_strike_event.lua]])
...
GameData["ui_hotkey_name"] = [[chaos_stun_grenade]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111541]] -- - Area effect ability/support weapon that blinds and defs all infantry targets within the area of effect with a bonus of morale loss.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18111542]] -- - 30m throwing range, 13m impact radius.
