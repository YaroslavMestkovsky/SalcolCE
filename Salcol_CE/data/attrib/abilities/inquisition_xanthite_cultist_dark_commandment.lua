...
GameData["child_ability_name"] = [[inquisition_xanthite_cultist_dark_commandment_child]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[Temporarily possess all daemons nearby, making them fight their own allies.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[As the spell grows close to wearing out and the daemons start regaining consciousness, the cultist simply kills the host]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/dark_commandment_ability]]
GameData["ui_info"]["screen_name_id"] = [[Daemonic enslavement]]
