...
GameData["area_effect"]["throw_data"]["direction_angle_random"] = 65
...
GameData["requirements"]["required_1"]["research_name"] = [[research\tau_wargear_commander_XV89_4.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Instantaneous shot that can pierce through all infantry and vehicle armours]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Can be fired from afar]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Needs a long time to cool down the shooting system after each shot]]
