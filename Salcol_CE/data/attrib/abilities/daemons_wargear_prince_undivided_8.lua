...
GameData["child_ability_name"] = [[daemons_wargear_prince_undivided_8_child]]
...
GameData["requirements"]["required_1"]["research_name"] = [[research\daemons_wargear_prince_undivided_8.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[All enemies that look at the prnce will feel a chill down their spine,]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[only to find themselves embraced by a deadly grip, ready to be slaughtered in a matter of few moments]]
