...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Call forth the shadows, granting invisibility to the whole squad]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The effect will only last for 20 seconds and detectors can still see through it]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_ripperswarm.tga]]
GameData["ui_info"]["screen_name_id"] = [[Cloack of shadows]]
