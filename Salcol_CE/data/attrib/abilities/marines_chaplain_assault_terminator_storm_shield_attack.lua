...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Chaplain charges a terrible attack with his storm shield]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The targeted unit will suffer a poderous strike that will cause stun effects and outstanding knockback]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Requires a setup time and can be used on infantry types, daemons excluded]]
GameData["ui_info"]["icon_name"] = [[space_marine_icons/storm_shield.tga]]
GameData["ui_info"]["screen_name_id"] = [[Heavy attack]]
