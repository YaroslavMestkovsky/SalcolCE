...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[guard\abilities\refractor]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[guard\abilities\refractor]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[guard\abilities\refractor]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[guard\abilities\refractor]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[guard\abilities\refractor]]
...
GameData["ui_hotkey_name"] = [[guard_commissar_unyielding]]
GameData["ui_index_hint"] = 2
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The commissar refuses to die while his duty is unfinished]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The Lord Commissar can not die for 15 seconds]]
GameData["ui_info"]["icon_name"] = [[guard_icons/immortality_icon]]
GameData["ui_info"]["screen_name_id"] = [[Unyielding]]
