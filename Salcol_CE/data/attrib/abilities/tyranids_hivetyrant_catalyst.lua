...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- A psychic ability that increases the regeneration rate all Tyranids in a 20m radius]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Left click to activate]]
