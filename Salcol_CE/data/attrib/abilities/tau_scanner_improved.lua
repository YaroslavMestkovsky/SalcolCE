...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_tau_orbital_scanner.lua]]
GameData["requirements"]["required_1"]["replace_when_done"] = true 
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\tau_scanner_improved.lua]]
