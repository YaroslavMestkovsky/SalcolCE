...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Boost the squad's running speed by 20%.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Reduces the accuracy of the squad by 20% for the whole duration]]
