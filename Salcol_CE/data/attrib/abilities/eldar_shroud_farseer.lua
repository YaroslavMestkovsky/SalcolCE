...
GameData["child_ability_name"] = [[eldar_shroud_farseer_child]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Infiltrate the targeted squad, as well as increasing speed and ranged damage resistence]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Infiltration and all other buffs are removed if the targeted squad is damaged]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/bonesong_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Shroud]]
