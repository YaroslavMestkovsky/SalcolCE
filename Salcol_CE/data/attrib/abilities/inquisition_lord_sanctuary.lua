...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[inquisition\sanctuary]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[inquisition\sanctuary]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[inquisition\sanctuary]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[inquisition\sanctuary]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[inquisition\sanctuary]]
...
GameData["ui_hotkey_name"] = [[inquisition_lord_sanctuary]]
GameData["ui_index_hint"] = 4
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$91551]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Engulfs the Inquisitor's soldiers in a protective shield.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The target squad  takes 90% reduced ranged damage.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Lasts for 15 seconds.]]
...
GameData["ui_info"]["screen_name_id"] = [[Sanctuary]]
