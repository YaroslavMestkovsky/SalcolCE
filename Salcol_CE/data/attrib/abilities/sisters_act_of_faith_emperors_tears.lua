...
GameData["ui_hotkey_name"] = [[sisters_canoness_emperors_tears]]
GameData["ui_index_hint"] = 10
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18112503]] -- - Timed aggressive ability, grants ranged and ability damage mitigation and dramatically increases the damage output of the user squad
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Restores morale and prevents successive morale damages]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Increase the squad damage output by 50%]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Provide 25% ranged and ability damage resistence]]
