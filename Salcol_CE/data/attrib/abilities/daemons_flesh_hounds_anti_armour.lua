...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Reduce attack damage against all infantry types in exchange for armour penetration especially against heavy infantry and vehicles]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Slightly more effective if chosen god is Khorne]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$92353]] -- - Left-click to activate.  Left-click again to deactivate.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$92354]] -- - Will remain on until turned off.
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_fury_of_khorne_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Penetrating bite]]
