...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[Dark_Eldar\SA_DamnedScreams]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"] = Reference([[modifiers\enable_squad_voice.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\daemons_wargear_herald_of_slaanesh_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Words of the dark prince surge from the daemonic gateway, stunning all non daemonic creatures for a short duration]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_slaanesh_spell.tga]]
GameData["ui_info"]["screen_name_id"] = [[Speech of the dark prince]]
