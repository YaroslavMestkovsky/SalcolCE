...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Restore the morale of all nearby infantry squads (25m) and prevent it from decreasing for 15 seconds]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Affects allies as well, but not monsters, daemons and commanders.]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/rally_ability.tga]]
GameData["ui_info"]["screen_name_id"] = [[Rally army]]
