...
GameData["child_ability_name"] = [[inquisition_xanthite_terror_medium]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[Cast an almost neverending blue flame that causes overtime damages to anything within]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/exterminatus_ability]]
GameData["ui_info"]["screen_name_id"] = [[Interdiction]]
