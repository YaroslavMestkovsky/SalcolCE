...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 1.019999981
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"]["value"] = 1.019999981
...
GameData["fire_cost"]["requisition"] = 105
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Permanently attach an inspiring banner on top of the rhino]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Allies within 20m will be psychologically affected, increasing morale and fighing prowness]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Can only be used once, since it lasts forever]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Affects all infantry types, monsters and daemons not included]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[$91773]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[sisters_icons/flag]]
GameData["ui_info"]["screen_name_id"] = [[Banner upgrade]]
