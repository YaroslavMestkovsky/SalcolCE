...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Allow to switch back and forth between the Exitus Rifle and Exitus Pistol]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The equipped weapon is the one displayed in this ability's icon]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[guard_icons/vindicare_switch_weapon]]
GameData["ui_info"]["screen_name_id"] = [[Switch Weapon]]
