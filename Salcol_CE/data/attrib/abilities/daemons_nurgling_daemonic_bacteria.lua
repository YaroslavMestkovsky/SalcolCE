...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Nurglings spread the plague around them by letting the smallest plaguelings enter the wounds of the enemy]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Enemies will suffer good health and morale degeneration as well as a minor movement speed reduction]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Left click to activate]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/fumigation_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Daemonic Bacteria]]
