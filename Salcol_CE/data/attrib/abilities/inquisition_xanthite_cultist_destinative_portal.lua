...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Psychic transport power]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[A portal is summoned from the psychic warp, allowing troops to move through it]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[The psychic portal will remain in a permanent spot unless it is destroyed]]
