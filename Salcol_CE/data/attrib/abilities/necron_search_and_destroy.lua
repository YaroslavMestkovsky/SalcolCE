...
GameData["ui_hotkey_name"] = [[necron_overseer_search_destroy]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210398]] -- - Timed support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18112182]] -- - Extends the sight and keen sight radius of the Cryptek for a duration.
