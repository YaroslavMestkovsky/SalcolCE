...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"] = Reference([[modifiers\enable_melee_leap.lua]])
...
GameData["requirements"]["required_2"]["research_name"] = [[research\inquisition_wargear_ordo_malleus_8.lua]]
