...
GameData["anticipation_lead_time"] = 0.3700000048
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[inquisition\edict_imperator]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[inquisition\edict_imperator]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[inquisition\edict_imperator]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[inquisition\edict_imperator]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[inquisition\edict_imperator]]
...
GameData["ui_hotkey_name"] = [[inquisition_lord_edict_imperator]]
GameData["ui_index_hint"] = 5
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$91551]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The target squad becomes filled with the purpose to destroy the enemies of mankind.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Removes weapon setup times for the target squad and increases their accuracy.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Lasts for 40 seconds.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Can only target Grey Knights.]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons\dark_commandment_ability]]
GameData["ui_info"]["screen_name_id"] = [[Edict Imperator]]
