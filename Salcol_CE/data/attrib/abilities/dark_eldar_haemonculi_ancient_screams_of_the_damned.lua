...
GameData["requirements"]["required_1"]["research_name"] = [[research\dark_eldar_research_screams_of_the_damned.lua]]
GameData["requirements"]["required_2"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_2"]["research_must_not_be_complete"] = true 
GameData["requirements"]["required_2"]["research_name"] = [[research\dark_eldar_research_screams_of_the_damned_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Many slughtered souls will cry out to to warn anyone not to get too close to the dark eldar]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Although some may able to proceed, they will be morally instable for a long time and their fighting capabilities will suffer from this as well]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Cannot affect commanders, Greater Daemons, buildings and titans]]
