...
GameData["child_ability_name"] = [[daemons_pink_horror_doombolt_3]]
...
GameData["entity_busy_time"] = 1.600000024
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The pink horror squad casts 5 accurate doombolts against the designated target]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Causes light damages but it's effective againt infantry and has low cooldown]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Uneffective against structures and vehicles]]
GameData["ui_info"]["icon_name"] = [[sisters_icons/ability_krak_grenades]]
GameData["ui_info"]["screen_name_id"] = [[Doombolt]]
