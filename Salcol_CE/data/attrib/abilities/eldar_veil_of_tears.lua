...
GameData["ui_hotkey_name"] = [[eldar_shadowseer_veil_of_tears]]
GameData["ui_index_hint"] = 4
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Drastically reduces ranged weapon accuracy of the target squad.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Lasts for 20 seconds.]]
