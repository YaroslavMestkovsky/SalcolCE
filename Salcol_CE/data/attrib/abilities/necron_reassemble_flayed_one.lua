...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_01"] = Reference([[type_armour\tp_necron_body_flayed_one.lua]])
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[Reassembles all fallen Flayed One in a 7m radius from the squad at a moderate power cost]]
