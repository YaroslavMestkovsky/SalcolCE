...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_18"] = Reference([[type_armour\tp_air_med.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["modifier"] = Reference([[modifiers\ability_energy_field_event.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18112390]] -- - Project a defensive shield around the structure within a 27m radius.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18112391]] -- - The shield grants 60% ranged damage immunity to all units and structures within the radius. However decreases melee damage resistance by 10%.
