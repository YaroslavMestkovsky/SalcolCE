...
GameData["requirements"]["required_2"]["research_name"] = [[research\chaos_wargear_lord_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Violently hit an enemy with the manreaper and send him into the air, where he'll bleed out in extreme pain.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[This ability has a very short cooldown and is effective at breaking enemy morale]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Can only be used on infantry squads]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/manreaper_research.tga]]
GameData["ui_info"]["screen_name_id"] = [[Scythe soul]]
