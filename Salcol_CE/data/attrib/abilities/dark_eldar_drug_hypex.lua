...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Hypex injections are widely used Dark Eldar soldiers when great reactivity is required]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Increases the speed of the user for a long time]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Lasts for 20 seconds]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$4100010]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/drug_hypex]]
GameData["ui_info"]["screen_name_id"] = [[Injection: Hypex Drug]]
