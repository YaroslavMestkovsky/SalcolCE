...
GameData["child_ability_name"] = [[inquisition_wargear_inquisitor_lord_3_lightning_balls_2]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\inquisition_wargear_inquisitor_lord_3.lua]]
