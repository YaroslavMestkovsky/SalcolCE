...
GameData["ui_hotkey_name"] = [[injection_grave_lotus_drug]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Grave Lotus injections send the user in a frenzy, dramatically increasing attack speed]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Even basic troopers turn out to be fearsome opponents until the effect wears off]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- WARNING: The squad will stop using ranged attacks as long as the effect lasts]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Lasts for 10 seconds]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$4100010]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/drug_grave_lotus]]
GameData["ui_info"]["screen_name_id"] = [[Injection: Grave Lotus Drug]]
