...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_04"] = Reference([[type_armour\tp_titan.lua]])
...
GameData["ui_hotkey_name"] = [[inquisition_calculus_psyker_vehicular_foundation]]
