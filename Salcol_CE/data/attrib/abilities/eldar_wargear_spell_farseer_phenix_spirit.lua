...
GameData["requirements"]["required_1"]["research_name"] = [[research\eldar_wargear_spell_farseer_phenix_spirit.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Farseer enables nearby eldar souls already migrated to their soulstone to remain in control of their physical bodies for a few moments even if the body were to die]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also greatly improve morale regeneration]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Affects all units in a 20m radius]]
