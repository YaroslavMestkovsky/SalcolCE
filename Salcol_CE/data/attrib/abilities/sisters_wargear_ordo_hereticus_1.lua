...
GameData["requirements"]["required_1"]["research_name"] = [[research\sisters_wargear_ordo_hereticus_1.lua]]
...
GameData["ui_hotkey_name"] = [[sisters_inquisitor_flame_ardent_blade]]
