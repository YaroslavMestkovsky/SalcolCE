...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Increase the sight and keen sight radius of the selected squad by 10m]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The squad's attacks will never miss for the whole duration]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Also increase the attack range by 10m]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4100104]] -- - Left-click and target an allied unit to activate.
