...
GameData["child_ability_name"] = [[inquisition_wargear_inquisitor_lord_5_child]]
...
GameData["requirements"]["required_1"]["research_name"] = [[research\inquisition_wargear_inquisitor_lord_5.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The inquisitor lord concentrates to create a shield around the landraider inquisition, providing damage immunity until depletion.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Movements will be disabled for the whole duration, which is 8 seconds if the shield isn't prematurely destroyed]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_base_shield]]
GameData["ui_info"]["screen_name_id"] = [[Shield focus]]
