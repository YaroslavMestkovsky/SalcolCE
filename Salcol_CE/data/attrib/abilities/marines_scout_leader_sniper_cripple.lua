...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"]["value"] = 0.400000006
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Snipe an enemy from afar]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Deal good damages to a single target and cripple them for several seconds]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Requires a long setup time before actually firing in exchange for an extreme range and accuracy]]
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_target_acquired_icon]]
GameData["ui_info"]["screen_name_id"] = [[Snipe]]
