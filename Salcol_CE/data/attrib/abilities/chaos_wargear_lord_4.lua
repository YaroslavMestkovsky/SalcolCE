...
GameData["requirements"]["required_2"]["research_name"] = [[research\chaos_wargear_lord_4.lua]]
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\chaos_auspex_of_discord.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Place an auspex of discord, which contains both the technology of an imperial auspex and a good amount of explosives.]]
...
GameData["ui_info"]["help_text_list"]["text_05"] = [[If the detonation is triggered by the auspex's readings, then the explosives will correctly blow up and deal more damages]]
