...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_16"]["screen_name_id"] = [[$4450037]] -- Aircraft
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_17"] = Reference([[type_armour\tp_titan.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_17"]["screen_name_id"] = [[$4450037]] -- Aircraft
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_18"] = Reference([[type_armour\tp_armour.lua]])
GameData["area_effect"]["sweeping_information"]["sweep_duration"] = 125
...
GameData["area_effect"]["throw_data"]["up_angle_min"] = 80
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_07"]["armour_piercing_value"] = 120
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_15"]["armour_piercing_value"] = 180
...
GameData["fire_cost"]["power"] = 10000
...
GameData["requirements"]["required_1"]["research_name"] = [[research\tau_orbital_defenses_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Ask a near planet dominated by tau forces for fire support]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Unsleash an orbital bombardment which effects will be global]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Stronger cannons are required in order to penetrate heavier armours.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Using them against infantry would be a waste]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[This bombardment will only aim vehicles. Annihilating them will cripple the enemy firepower]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[All enemy vehicles will inesorably end up in the aim of those cannons, suffering a tremendous amount of damage]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[Living metal will also be targeted by this attack]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/blood_pulse_icon]]
GameData["ui_info"]["screen_name_id"] = [[Anti-vehicle orbital strike]]
