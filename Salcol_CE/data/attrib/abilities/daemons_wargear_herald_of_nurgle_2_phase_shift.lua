...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"]["value"] = 1.799999952
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\enable_infiltration_veil_of_darkness.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"]["value"] = 4
...
GameData["requirements"]["required_1"]["research_name"] = [[research\daemons_wargear_herald_of_nurgle_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Causes the user to shift out of material universe, becoming invulnerable and invisible.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Moreover, speed is drastically increased and the user can focus his abilities on regenerating.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Using this ability extends time for the caster, allowing them to return in what seems to be a few seconds]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_ability_plane_shift_icon2.tga]]
