...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"] = Reference([[modifiers\min_range_weapon_modifier.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"] = Reference([[modifiers\enable_melee.lua]])
...
GameData["ui_hotkey_name"] = [[necron_gauss_weapon_overcharge]]
GameData["ui_index_hint"] = 2
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Toggleable ability]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210388]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- The squad will receive a +15% boost in firepower and range]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- On the other hand, the squad will not be able to fire in close combat (10m) and will be unable to defend themselves in melee]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Also increase by 30% the damage taken in melee of the user squad]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$18210390]] -- - Left-click to activate!
