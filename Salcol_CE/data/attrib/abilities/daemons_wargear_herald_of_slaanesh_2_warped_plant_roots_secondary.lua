...
GameData["caster_damage"]["hit_events"]["entry01"]["event"] = [[unit_ability_fx/daemon_strength]]
GameData["caster_damage"]["hit_events"]["entry02"]["event"] = [[unit_ability_fx/daemon_strength]]
GameData["caster_damage"]["hit_events"]["entry03"]["event"] = [[unit_ability_fx/daemon_strength]]
GameData["caster_damage"]["hit_events"]["entry04"]["event"] = [[unit_ability_fx/daemon_strength]]
GameData["caster_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["caster_damage"]["hit_events"]["entry05"]["surface"] = Reference([[type_surface\tp_monolith.lua]])
GameData["caster_damage"]["modifiers"]["modifier_01"]["max_lifetime"] = 10
GameData["caster_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\health_regeneration_modifier.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The warped tree uses its roots to attack the enemy from under their foot, catching them off guard and binding them to the ground]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Enemies will not be able to use abilities, jump, attack or move for the whole duration]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Also some life force is drained from the victims and granted to the warped tree]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$91756]] -- - Does not affect vehicles.
GameData["ui_info"]["icon_name"] = [[chaos_icons/chainsoftorment_icon]]
GameData["ui_info"]["screen_name_id"] = [[Malevolent roots]]
