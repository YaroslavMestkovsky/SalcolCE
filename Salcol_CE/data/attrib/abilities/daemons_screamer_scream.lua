...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Screamers emit such powerful screams that enemies will lose composure and suffer knockback]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_bloodfrenzy_icon.tga]]
