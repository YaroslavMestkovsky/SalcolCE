...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_squad_weapons.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\guard_wargear_field_support_1.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Spur the squad to fight.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Affected units will receive varius bonuses for some seconds:]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Immunity to health and morale damages]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Speed, accuracy and attack speed enhancment]]
