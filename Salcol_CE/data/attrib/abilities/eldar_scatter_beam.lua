...
GameData["ui_hotkey_name"] = [[eldar_vehicles_fire_prism_beam]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$92331]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18111226]] -- - Off = Focused Beam, area effect, effective at disrupting infantry formations and against vehicle armor.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18111227]] -- - On = Scatter Beam, rapid fire, effective against all armored types including titans.
