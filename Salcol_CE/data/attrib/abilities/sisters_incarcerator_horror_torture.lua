...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 220
...
GameData["ui_hotkey_name"] = [[sisters_incarcerator_horror_torture]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Torture the Horror caged in the vehicle in order to make it release power to harness in order to enhance the vehicle's performance]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- This will bring the vehicle's hardware to the limit, damaging it overtime]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- In exchange, +10% damage, +20% attack speed and slight armour penetration are granted to the user until deactivated]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Beware! The vehicle can be destroyed by this ability]]
GameData["ui_info"]["icon_name"] = [[sisters_icons/witch_hunters_incarcerator_horror_torture_icon]]
GameData["ui_info"]["screen_name_id"] = [[Horror Torture]]
