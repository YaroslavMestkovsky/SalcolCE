...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_03"] = Reference([[type_armour\tp_monster_med.lua]])
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[- All affected monstrous creatures or commanders are flung around in an area effect, brutally taking damaging for the whole spell duration.]]
