...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The warboss emits a tremendous roar, startling any nearby enemy]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Morale suddenly drops in a good radius and morale regeneration is lowered for some seconds]]
...
GameData["ui_info"]["screen_name_id"] = [[Vehement roar]]
