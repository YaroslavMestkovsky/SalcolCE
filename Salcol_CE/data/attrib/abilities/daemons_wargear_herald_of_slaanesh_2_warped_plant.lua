...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\daemon_warped_plant.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Infuse a nearby life form with warp powers, making it have a growth spurt]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The plant will also grow aggressive and will develop vile desires, detecting nearby enemies and disturbing them with its roots, lowering the opponents' speed]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[The organism's degeneration will unrelentingly lead to the plant's death]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_capillary_errection_ability.tga]]
GameData["ui_info"]["screen_name_id"] = [[Warped plant]]
