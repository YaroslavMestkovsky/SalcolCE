...
GameData["child_ability_name"] = [[daemons_plague_bearer_daemonic_larvae_ally]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Plague Bearers release some Blighted Chaos Spawns, infecting everyone nearby.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Allies take less damages compared to enemies from this skill]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Left click to activate]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/fumigation_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Daemonic Larvae]]
