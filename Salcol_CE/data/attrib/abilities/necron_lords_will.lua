...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"] = Reference([[modifiers\ability_eldar_guide_event.lua]])
...
GameData["ui_hotkey_name"] = [[necron_lord_will]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The targeted squad will become immune to morale damages for 10 seconds]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Also double morale regeneration for the whole duration]]
GameData["ui_info"]["icon_name"] = [[necron_icons/lords_will]]
GameData["ui_info"]["screen_name_id"] = [[Lords Will]]
