...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\ability_necron_phase_shift_event.lua]])
...
GameData["ui_hotkey_name"] = [[necron_shadow_shifter]]
