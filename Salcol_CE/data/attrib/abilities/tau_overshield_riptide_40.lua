...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Usable only if at least one shield is still in function]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Prevents incoming damages for 9 seconds at a moderate power cost]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$666102]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_overshield_riptide_icon2]]
GameData["ui_info"]["screen_name_id"] = [[High Priority Overcharged Shield]]
