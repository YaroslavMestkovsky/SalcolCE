...
GameData["child_ability_name"] = [[sisters_supreme_laud_hailers_e2]]
...
GameData["requirements"]["required_1"] = Reference([[requirements\required_health]])
GameData["requirements"]["required_1"]["min_health_fraction"] = 0.6999999881
GameData["requirements"]["required_2"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_2"]["addon_name"] = [[addons\addon_sisters_supreme_laud_hailers_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Globally damage enemy morale while enhancing the sisters infantry's one]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Requires 70% health to operate]]
