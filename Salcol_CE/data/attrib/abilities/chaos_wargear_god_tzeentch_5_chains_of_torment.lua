...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Daemonic chains that entangle all enemies nearby]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[$91754]] -- - Prevents the squad from moving for a short period of time.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$91755]] -- - Does minor damage.
