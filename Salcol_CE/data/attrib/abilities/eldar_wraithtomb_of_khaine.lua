...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"]["value"] = 300
...
GameData["ui_hotkey_name"] = [[eldar_revenant_titan_enhanced_wraithbone_regeneration]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18112264]] -- - If turned on, the user will regenerate 300 health per second.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18112265]] -- - Also prevents the user from attacking and moving at all
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18112266]] -- - Lastly, increase the damage taken by 30% for the whole duration
GameData["ui_info"]["help_text_list"]["text_05"] = [[$575450]] -- - Left-click to activate.
