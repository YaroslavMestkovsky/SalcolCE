...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Temporarily enhance high frequencies that compose the champion weapon's sound.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Dramatically increase damage against all infantry types]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$91773]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[chaos_icons/freq_high]]
GameData["ui_info"]["screen_name_id"] = [[High frequency waveform]]
