...
GameData["child_ability_name"] = [[necron_energies_reallocation_doomsday_child]]
...
GameData["ui_hotkey_name"] = [[necron_doomsday_monolith_energies_reallocation]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Drain most of the Doomsday Monolith to irradiate it on all entities in a 36m radius.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- ALL entities will suffer heavy damage, especially infantry]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Nearby allied necron units will receive some good buffs for the whole duration though]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- The monolith will be unable to move and will suffer way more damages for the whole duration]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Applied bonuses are: Immunity to knockdown, Morale regen +25, HP regen +15, attack range +15%, movement speed +20% and damage dealt +15%]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$0]]
GameData["ui_info"]["help_text_list"]["text_07"] = [[- The Doomsday Monolith will take 25% more damages from all sources]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[- Lasts for 20 seconds]]
GameData["ui_info"]["icon_name"] = [[necron_icons/doomsday_energy_reallocation]]
GameData["ui_info"]["screen_name_id"] = [[- Necron Energies Reallocation]]
