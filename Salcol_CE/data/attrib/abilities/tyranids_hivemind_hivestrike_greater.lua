...
GameData["requirements"]["required_3"]["structure_name"] = [[ebps\races\tyranids\structures\tyranids_carnifex_hive.lua]]
...
GameData["ui_hotkey_name"] = [[tyranids_hive_meteor_strike]]
