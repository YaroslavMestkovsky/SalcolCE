...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[inquisition\astral_aim]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[inquisition\astral_aim]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[inquisition\astral_aim]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[inquisition\astral_aim]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[inquisition\astral_aim]]
...
GameData["ui_hotkey_name"] = [[inquisition_lord_astral_aim]]
GameData["ui_index_hint"] = 3
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$91551]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The Lord Inquisitor Channels his psychic powers to boost his soldiers' aim.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Doubles the range of the target squads weapons.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Lasts for 30 seconds.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Can not target Grey Knights or Commanders.]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/astral_aiming]]
GameData["ui_info"]["screen_name_id"] = [[Astral Aim]]
