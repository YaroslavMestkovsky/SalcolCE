...
GameData["ui_hotkey_name"] = [[zoanthrope_catalyst]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Activate a catalyst effect that will increase the regeneration of all troops in a 35m radius.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The effect will last 25 seconds regardless of the distance from the caster]]
