...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Screamers emit screams which frequencies resonate with that of enemy materials, drastically weakening them for a very short time]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[In addition to that, little knockback and morale damages are applied]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_bloodhaste_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Resonating scream]]
