...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 15000
...
GameData["requirements"]["required_1"]["research_name"] = [[research\chaos_wargear_god_khorne_4.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[All infantry units, monsters and daemons in a 100m radius will suffer deadly damages and will not be able to regenerate for a good duration.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Morale is tested to the limit, leading even stalwarts to crazyness]]
