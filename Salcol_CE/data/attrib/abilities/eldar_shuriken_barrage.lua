...
GameData["ui_hotkey_name"] = [[eldar_vehicles_shuriken_barrage]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Overwhelm enemies with a huge amount of bullets]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Deal significant damage to all infantry types and reduce enemy speed in the area]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/shuriken_barrage]]
GameData["ui_info"]["screen_name_id"] = [[Shuriken barrage]]
