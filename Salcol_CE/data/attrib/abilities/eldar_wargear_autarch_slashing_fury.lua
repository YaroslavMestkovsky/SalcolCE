...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The autarch temporarily stops the time and cruelly slices with his sword anything nearby.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[All infantry types and commanders will suffer mortal damage.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Vehicles with insufficient armour rating will incur in the same consequences.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Buildings will be unaffected]]
GameData["ui_info"]["icon_name"] = [[eldar_icons\eldar_liquefy_icon]]
GameData["ui_info"]["screen_name_id"] = [[Slashing fury]]
