...
GameData["requirements"]["required_2"]["research_name"] = [[research\eldar_spell_holosuit_improved.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_health.lua]])
