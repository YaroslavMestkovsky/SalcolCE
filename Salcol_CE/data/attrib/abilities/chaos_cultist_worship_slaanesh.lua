...
GameData["child_ability_name"] = [[chaos_cultist_worship_worship_tzeentch]]
...
GameData["looping_event_name"] = [[daemons/god_slaanesh_ability]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- This abilities allows the cultists to channel for 10 seconds and then near-instantly break the target squads morale]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Lasts 10 seconds]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Should the target move out of range while the cultists are still channeling, the ability will be nullified and the cultists will try to move back into range, but can not cast this ability again]]
...
GameData["ui_info"]["help_text_list"]["text_06"] = [[- For the whole duration, the squad will regenerate morale 50% faster]]
