...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Drain most of the Doomsday Monolith to irradiate it on all nearby entities.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- ALL entities will suffer heavy damage overtime and will be continuously blinded]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[- The monolith will be unable to move and will suffer way more damages for a long duration]]
