...
GameData["child_ability_name"] = [[guard_primaris_emperors_shield_child]]
...
GameData["ui_hotkey_name"] = [[guard_primaris_psyker_emperors_shield]]
GameData["ui_index_hint"] = 5
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$92301]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Calls upon the Emperors divine might to protect his soldiers.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- After a channel, the target starts to project an aura of invulnerability.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- The target must remain withing range for the entire channel, or the ability will fizzle out.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["icon_name"] = [[guard_icons/emperors_shield_icon]]
GameData["ui_info"]["screen_name_id"] = [[Emperors Shield]]
