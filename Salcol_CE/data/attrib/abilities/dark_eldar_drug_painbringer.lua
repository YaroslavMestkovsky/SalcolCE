...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"] = Reference([[modifiers\ability_mandate_event.lua]])
...
GameData["recharge_timer_id"] = 766
...
GameData["ui_hotkey_name"] = [[injection_painbringer_drug]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4100008]] -- - Injects an infusion of drugs that boosts the user squad by providing a variety of buffs:
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Painbringer injections make the user numb to pain and clouds other perceptions]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- A warrior injected with this drug will keep fighting even when his body should have long failed him]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Very useful to keep enemies engaged in melee for long times or blocking high priority targets for a longer time]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- On the other hand, the user's accuracy drops dramatically]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[- Lasts for 10 seconds]]
GameData["ui_info"]["help_text_list"]["text_07"] = [[$4100010]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/drug_painbringer]]
GameData["ui_info"]["screen_name_id"] = [[Injection: Painbringer Drug]]
