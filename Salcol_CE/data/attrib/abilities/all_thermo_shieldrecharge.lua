...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Decreases the ability recharge time of all titans by 80% for20 seconds.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also increase their movement speed by 20% for the whole duration.]]
...
GameData["ui_info"]["screen_name_id"] = [[Titanic Power Overcharge]]
