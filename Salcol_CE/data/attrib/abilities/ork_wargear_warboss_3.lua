...
GameData["requirements"]["required_1"]["research_name"] = [[research\ork_wargear_warboss_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Boosts da speed o' da warboss an' makes him da speedest ork eva']]
