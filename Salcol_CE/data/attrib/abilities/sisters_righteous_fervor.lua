...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- While active, the Sister Repentia will move 30% faster and receives a 20% damage bonus]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- The Sister Repentia will also suffer slightly more damage]]
