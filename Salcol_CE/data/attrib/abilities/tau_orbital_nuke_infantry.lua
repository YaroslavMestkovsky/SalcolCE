...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_02"]["armour_piercing_value"] = 120
...
GameData["range"] = 0
GameData["recharge_time"] = 480
GameData["recharge_timer_global"] = false
GameData["recharge_timer_id"] = 0
GameData["refresh_time"] = 1
GameData["requirements"] = Reference([[tables\requirements.lua]])
GameData["requirements"]["required_1"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_1"]["research_name"] = [[research\tau_orbital_defenses_1.lua]]
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[This bombardment will only aim living creatures, as it's only effective against them.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[(Like the arka cannon's shots on nan yanoy)]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[All infantry units will inesorably end up in the aim of those cannons, suffering a tremendous amount of damage]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/blood_pulse_icon]]
GameData["ui_info"]["screen_name_id"] = [[Anti-flesh orbital strike]]
