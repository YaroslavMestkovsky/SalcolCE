...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_01"] = Reference([[type_armour\tp_necron_body_deathmark.lua]])
...
GameData["ui_hotkey_name"] = [[necron_deathmarks_reassemble]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210398]] -- - Timed support ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[Reassembles all fallen Deathmark in a 7m radius from the squad at a moderate power cost]]
