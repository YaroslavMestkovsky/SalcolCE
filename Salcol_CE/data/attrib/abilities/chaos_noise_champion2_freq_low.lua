...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Temporarily enhance low frequencies that compose the champion weapon's sound.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Increase damage dealt against vehicles and structures]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$91773]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[chaos_icons/freq_low]]
GameData["ui_info"]["screen_name_id"] = [[Low frequency waveform]]
