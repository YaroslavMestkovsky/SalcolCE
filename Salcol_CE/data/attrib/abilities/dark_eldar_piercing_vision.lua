...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4100039]] -- - Temporarily reduces morale and morale regeneration of all enemy infantry squads in a 40m radius.
GameData["ui_info"]["help_text_list"]["text_03"] = [[- The effect lasts for 15 seconds]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4100040]] -- - Left-click on the ground to activate.
