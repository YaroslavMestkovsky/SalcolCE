...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[chaos/blood_pulse_hit]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["max_lifetime"] = 16
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["max_lifetime"] = 16
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["max_lifetime"] = 16
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["max_lifetime"] = 16
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_09"]["modifier"]["value"] = 0
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_10"] = Reference([[tables\time_modify_entry.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_10"]["max_lifetime"] = 8
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_10"]["modifier"]["value"] = 0
...
GameData["child_ability_name"] = [[daemons_fiend_of_slaanesh_unbearable_torture_child]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Fiend of Slaanesh conjures the warp powers to keep the victim healed while a deathless pain is inflicted with the only purpose of inducing self pleasure while ravaging the other's body and mind]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The targeted enemy will be unable to act for a long time and there will be consequences when the Fiend of Slaanesh interrupts the spell]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_mark_of_blood_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Unbearable torture]]
