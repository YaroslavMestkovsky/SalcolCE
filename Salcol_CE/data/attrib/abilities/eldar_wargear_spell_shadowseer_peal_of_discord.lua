...
GameData["requirements"]["required_2"]["research_name"] = [[research\eldar_wargear_spell_shadowseer_peal_of_discord.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Shadowseer unleashes a very powerful sound wave that deals extreme damage especially against light infantry in a good radius]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[This spell affects allies as well, it must be used with maximum caution and accuracy]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/plasmagrenades_icon.tga]]
