...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"]["value"] = 20
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_10"]["modifier"] = Reference([[modifiers\max_range_weapon_modifier.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\sisters_assassin_weapons.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Toggleable ability: Root the Assassin, increasing ranged weapon damage and sight radius]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Prevents the Assassin from moving.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Left-click to activate!]]
GameData["ui_info"]["icon_name"] = [[sisters_icons/ability_perceptions]]
GameData["ui_info"]["screen_name_id"] = [[Sharpen perceptions]]
