...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[chaos/bubbles]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[chaos/bubbles]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[chaos/bubbles]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[chaos/bubbles]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[chaos/bubbles]]
...
GameData["ui_hotkey_name"] = [[chaos_transfix]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$91751]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The target squad becomes completely entranced by visions ]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The squad becomes unable to act for 30 seconds]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/slaanesh_blessing]]
GameData["ui_info"]["screen_name_id"] = [[Transfix]]
