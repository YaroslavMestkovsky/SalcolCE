...
GameData["ui_hotkey_name"] = [[sisters_repentia_righteous_fervor]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Drives the Assassin squad to fight harder, to their detriment]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- While active, the Assassin will move 30% faster and receives a 20% damage bonus]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- The Assassin will also suffer slightly more damage]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4300075]] -- - Left-click to activate.  Left-click again to de-activate.
