...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[guard/abilities/psyker_shield]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[guard/abilities/psyker_shield]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[guard/abilities/psyker_shield]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[guard/abilities/psyker_shield]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[guard/abilities/psyker_shield]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"]["value"] = 0.3300000131
...
GameData["ui_hotkey_name"] = [[guard_primaris_psyker_psychic_barrier]]
GameData["ui_index_hint"] = 3
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$91551]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The psyker projects a barrier of psychic energy to protect his allies.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Reduces damage taken by the target squad by 66% for 40 seconds.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[guard_icons/psychic_barrier_icon]]
GameData["ui_info"]["screen_name_id"] = [[Psychic Barrier]]
