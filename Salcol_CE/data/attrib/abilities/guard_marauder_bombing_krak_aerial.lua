...
GameData["child_ability_name"] = [[guard_marauder_bombing_krak_2]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The marauder bomber gets ready to drop a huge pack of krak grenades]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Several seconds are to pass before the explosives will actually fall]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Some krak grenades will actually fall without much delay]]
GameData["ui_info"]["icon_name"] = [[guard_icons/krak_bombs_icon]]
GameData["ui_info"]["screen_name_id"] = [[Bombing run krak (aerial)]]
