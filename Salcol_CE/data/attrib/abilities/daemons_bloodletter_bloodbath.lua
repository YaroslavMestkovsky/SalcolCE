...
GameData["ui_info"]["help_text_list"]["text_02"] = [[The Bloodletters emit a daemonic pulse that corrupts and scorches the flesh of non daemonic infantry.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[All units will be affected in a 20m radius]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/blood_pulse_icon]]
GameData["ui_info"]["screen_name_id"] = [[Bloodbath]]
