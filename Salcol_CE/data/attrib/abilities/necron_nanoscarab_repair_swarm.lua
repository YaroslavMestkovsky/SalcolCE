...
GameData["ui_hotkey_name"] = [[ghost_ark_nanoscarab_repair_swarm]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The targeted squad will recieve significantly increased health regeneration for the duration of this ability]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Lasts 25 seconds]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Can only be cast on Warriors and Flayed Ones]]
GameData["ui_info"]["icon_name"] = [[necron_icons/harvest_mode]]
GameData["ui_info"]["screen_name_id"] = [[Nanoscarab Repair Swarm]]
