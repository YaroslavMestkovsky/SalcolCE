...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Restore the titan's durability overtime]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Also improve the ranged shield for the whole duration]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Left-click to activate.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/soul_shield_overcharge]]
GameData["ui_info"]["screen_name_id"] = [[Overcharge Shield]]
