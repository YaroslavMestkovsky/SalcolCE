...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\ability_tau_mark_target_event.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["modifier"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_percentage.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Mark any target for a very long time]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Marked targets take additional damages and cannot hide no matter where they may flee]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Can only target infantry squads, commanders and vehicles]]
GameData["ui_info"]["icon_name"] = [[guard_icons/vindicare_mark]]
GameData["ui_info"]["screen_name_id"] = [[Assassin's Mark]]
