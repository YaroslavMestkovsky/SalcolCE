...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Usable only while both shield layers are still active]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Prevents incoming damages for 10 seconds at a small power cost]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$666102]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_overshield_riptide_icon1]]
GameData["ui_info"]["screen_name_id"] = [[Optimal Overcharged Shield]]
