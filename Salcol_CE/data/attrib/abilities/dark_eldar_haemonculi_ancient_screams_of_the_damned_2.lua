...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_09"]["modifier"]["value"] = 0.8000000119
...
GameData["requirements"]["required_1"]["research_name"] = [[research\dark_eldar_research_screams_of_the_damned_2.lua]]
GameData["requirements"]["required_2"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_2"]["research_must_not_be_complete"] = true 
GameData["requirements"]["required_2"]["research_name"] = [[research\dark_eldar_research_screams_of_the_damned_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[- In that moment of weakness, the tortured souls will posses their victims for a short time, driving them crazy and making them shoot their own allies]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Cannot affect commanders, Greater Daemons, buildings and titans]]
