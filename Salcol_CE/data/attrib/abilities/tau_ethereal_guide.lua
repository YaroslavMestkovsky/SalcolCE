...
GameData["ui_hotkey_name"] = [[tau_etherial_technology]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$92364]] -- - Affected squad will not miss any attack for 25 seconds.
GameData["ui_info"]["help_text_list"]["text_03"] = [[- All affected weapons will also have increased attack rate by 20%.]]
