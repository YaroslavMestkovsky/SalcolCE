...
GameData["child_ability_name"] = [[guard_marauder_bombing_inferno_2]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The marauder bomber gets ready to drop a huge pack of inferno grenades]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Some inferno grenades will actually fall without much delay]]
GameData["ui_info"]["icon_name"] = [[guard_icons/incendiary_bombs_icon]]
GameData["ui_info"]["screen_name_id"] = [[Bombing run inferno (aerial)]]
