...
GameData["ui_info"]["help_text_list"]["text_02"] = [[Bloodthirsters of Unfettered Fury are Bloodthirsters that don't specialise any combat technique, mantaining a versatile fighting style]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Incompatible with the third and sixth hosts]]
...
GameData["ui_info"]["screen_name_id"] = [[Eighth host: Bloodthirsters of Unfettered Fury]]
