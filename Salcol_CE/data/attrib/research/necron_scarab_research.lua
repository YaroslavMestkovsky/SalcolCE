...
GameData["modifiers"]["modifier_09"]["target_type_name"] = [[necron_scarabs]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Increase the durability (especially ranged) of Builder and Attack Scarabs]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Slightly increase the capture speed of Builder Scarabs]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Improve the melee weapon of Attack Scarabs (especially against infantry and commanders)]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Attack Scarabs refund 1 power when they die]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[- Allows scarabs to jump.]]
