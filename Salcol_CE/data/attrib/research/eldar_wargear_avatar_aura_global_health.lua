...
GameData["time_cost"]["time_seconds"] = 310
GameData["ui_hotkey_name"] = [[hotkey_a]]
GameData["ui_index_hint"] = 9
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Globally increase the health of all friendly infantry.]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Doesn't need to be repurchased if the Avatar dies.]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/great_webway_building_strengthen_research_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Global aura: Health]]
