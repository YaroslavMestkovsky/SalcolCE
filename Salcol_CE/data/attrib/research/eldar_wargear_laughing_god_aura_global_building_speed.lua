...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Globally increase the Building speed of all builders.]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Requiers Tier 4]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/eldar_wargear2_rune_doom.tga]]
GameData["ui_info"]["screen_name_id"] = [[Global aura: Building speed]]
