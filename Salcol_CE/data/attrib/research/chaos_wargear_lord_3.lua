...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The chaos lord expresses the fun he is having fighting by laughing in a terrific way.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The morale of the enemy infantry will crumble while in proximity of the chaos lord]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/daemonic_laught.tga]]
GameData["ui_info"]["screen_name_id"] = [[Daemonic laught]]
