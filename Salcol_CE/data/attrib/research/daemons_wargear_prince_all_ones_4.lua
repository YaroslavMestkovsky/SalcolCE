...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Unlock the Darkest Blasphemy ability, which inflics debuffs on all targeted enemies as well as breaking their morale]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Requires Tier 1]]
