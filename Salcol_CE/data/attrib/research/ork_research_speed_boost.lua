...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Gives most Ork light vehicles the Speed Boost ability.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Ability boosts the movement speed greatly for the vehicles.]]
