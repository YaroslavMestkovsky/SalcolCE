...
GameData["requirements"]["required_2"]["global_addon_name"] = [[addons\inquisition_inquisitor_lord_destruction_incarnate_addon.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\global_required_addon.lua]])
GameData["requirements"]["required_3"]["global_addon_name"] = [[addons\inquisition_inquisitor_lord_destruction_incarnate_addon.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Replace the current weapons with ]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The inquisitor lord will focus his magic abilities on the sword, limiting the use of spells but increasing the armour penetration]]
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons/Incinerator_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Infused weaponry]]
