...
GameData["requirements"]["required_2"]["research_name"] = [[research\daemons_greater_gift_guo_health_armour.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["is_display_requirement"] = true 
GameData["requirements"]["required_3"]["research_name"] = [[research\daemons_greater_gift_guo_health_armour.lua]]
GameData["requirements"]["required_4"] = Reference([[requirements\required_research]])
GameData["requirements"]["required_4"]["research_name"] = [[daemons_mark_nurgle]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The great unclean one stomps the enemies and suffocate them with poisonous gas and a viscid slime]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Deals overtime damages to anyone engaged in melee combat]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_guo_3.tga]]
