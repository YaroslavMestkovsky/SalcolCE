...
GameData["ui_info"]["help_text_list"]["text_07"] = [[$18210085]] -- - Makes all Conscript Guardsmen free to produce (but not to reinforce) and increases the maximum squad loadout by 10.
