...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the Daemon Prince to passively emit little waves of immaterium energies]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Enemy squads in a short area will not be able to reinforce due to the transmissions being interrupted.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Necrons will suffer the same effects due to resonance and instability during the restoring process]]
...
GameData["ui_info"]["screen_name_id"] = [[Immaterium energies I]]
