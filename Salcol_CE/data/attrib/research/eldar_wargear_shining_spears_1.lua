...
GameData["modifiers"]["modifier_01"] = Reference([[modifiers\enable_hardpoint_05.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Add a twin linked shuriken catapult to all shining spears bikes]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Add a shuriken cannon to the exarch's bike]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/shuriken_cannon_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Additional shuriken weaponry]]
