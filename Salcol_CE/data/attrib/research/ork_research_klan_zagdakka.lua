...
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211569]] -- - The Orks are given +10 population, +50% special ability recharge rates, +50% ability ranges, and +50% extra sight radius so long as the Weirdboy remains alive.
GameData["ui_info"]["help_text_list"]["text_04"] = [[Also, this Klan's Wierdboy is provided with three zzzappy and inspiring items]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[$18211570]] -- - Incompatible with Orks of Klan Gorgutz, Orks of Armageddon, and Orks of Klan Nuddyfist.
