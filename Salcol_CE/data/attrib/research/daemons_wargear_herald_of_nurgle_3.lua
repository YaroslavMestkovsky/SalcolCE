...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Grants an ability that greatly reduces the enmies income for a short duration.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Requirees tier 5]]
