...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Replace the melee weapon with a Nemesis power force sword]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Grants heavy damage and armour penetration]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- DPS: 438-700]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Requires Tier 3]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/tome_blades_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Anointed blade]]
