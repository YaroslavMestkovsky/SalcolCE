...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemon_guo]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\daemons_greater_gift_guo_health_regeneration.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["is_display_requirement"] = true 
GameData["requirements"]["required_3"]["research_name"] = [[research\daemons_greater_gift_guo_health_regeneration.lua]]
GameData["requirements"]["required_4"] = Reference([[requirements\required_research_either]])
GameData["requirements"]["required_4"]["research_name_either"] = [[research\daemons_mark_nurgle.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The flesh of the great unclean one becomes so callous that no weapon seems suitable for penetrating it]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Greatly increase health and armour]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_guo_2.tga]]
GameData["ui_info"]["screen_name_id"] = [[Desecrated flesh]]
