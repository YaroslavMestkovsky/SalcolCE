...
GameData["modifiers"]["modifier_03"]["target_type_name"] = [[chaos_squad_sorcerer_advance_sp]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This particular rune confers to the wearer unparalleled spellcasting capabilities but will sometimes cloud the mind of the wearer.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[More morale damage will be suffered in exchange for heavy casting augmentations.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/mark_of_tzeentch.tga]]
GameData["ui_info"]["screen_name_id"] = [[Rune of Tzeentch]]
