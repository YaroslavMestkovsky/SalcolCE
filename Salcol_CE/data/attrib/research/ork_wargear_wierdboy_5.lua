...
GameData["requirements"]["required_6"]["research_name"] = [[research\ork_wargear_wierdboy_1.lua]]
...
GameData["requirements"]["required_7"]["research_name"] = [[research\ork_wargear_wierdboy_1.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Add a new kind of frazzle that affects buildings only]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Instead of dealing huge amounts of damage,]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[slow and inesorable health degeneration will be applied for a very long time]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Damage applied will depend on the armor level of the affected buildings]]
GameData["ui_info"]["icon_name"] = [[ork_icons/wierdboy_frazzle.tga]]
