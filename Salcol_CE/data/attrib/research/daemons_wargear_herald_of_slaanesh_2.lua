...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemon_squad_daemonettes]]
...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[daemon_squad_daemonettes_greater]]
...
GameData["modifiers"]["modifier_03"]["target_type_name"] = [[daemon_squad_fiends]]
...
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[daemon_squad_slaanesh_herald]]
...
GameData["modifiers"]["modifier_05"]["target_type_name"] = [[daemon_squad_keeper_of_secrets]]
GameData["modifiers"]["modifier_05"]["value"] = 0.8999999762
GameData["modifiers"]["modifier_06"] = Reference([[modifiers\enable_melee_leap.lua]])
GameData["modifiers"]["modifier_06"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_06"]["target_type_name"] = [[daemon_herald_of_slaanesh]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Increase the attack speed of all Slaanesh daemons (Herald included)]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Furthermore, allow the Herald to charge and sprint with lightning speed as well as placing warped plants to detect the enemy]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Requires tier 4]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_herald_slaanesh_icon]]
GameData["ui_info"]["screen_name_id"] = [[Greater mark of slaanesh]]
