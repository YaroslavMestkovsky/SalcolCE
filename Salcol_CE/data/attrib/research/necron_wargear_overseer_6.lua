...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Causes the spell to deal more damage and knockback the enemy more often.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Requires Tier 2.]]
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_lightning_storm_research.tga]]
GameData["ui_info"]["screen_name_id"] = [[Upgrade spell: lightning storm]]
