...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the Brotherhood Champion to cast the Hammerhand spell, which enhances the user's strength for a short period]]
