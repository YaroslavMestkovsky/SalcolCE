...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[daemon_bloodthirster]]
...
GameData["requirements"]["required_2"]["research_name"] = [[daemons_mark_slaanesh]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Improve sight range of all Bloodthirsters]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also allow to detect nearby infiltrated enemies]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_bloodthirster_1.tga]]
GameData["ui_info"]["screen_name_id"] = [[Sharp perceptions]]
