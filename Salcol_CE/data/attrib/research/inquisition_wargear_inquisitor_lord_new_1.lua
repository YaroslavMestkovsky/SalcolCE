...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Equips a Daemon Blade]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Effective vs Heavy Infantry.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Effective vs Elite Heavy Infantry]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Effective vs Daemons]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/Incinerator_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Daemon Blade]]
