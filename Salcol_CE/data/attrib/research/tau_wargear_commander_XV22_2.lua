...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This new class armor, incorporated with step assist equipment, offers great damage and knockback protection,]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[while boosting the speed consistently]]
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_titan_armor_research.tga]]
