...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Equip a Firestorm Blade, a massive Daemon Weapon of Khorne wielded only by the Blood God's moist favored Bloodthirsters.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The blade is a massive straight sword engulfed in white fire.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[At the whim of its wielder, the blade can discharge great plumes of flame over considerable distances.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 167-217]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/exterminate_and_conquer_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Firestorm Blade]]
