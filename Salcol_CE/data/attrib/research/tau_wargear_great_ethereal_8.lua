...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Greatly increase the Great Ethereal melee capabilities,]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[making him a very worthy enemy on the front]]
GameData["ui_info"]["icon_name"] = [[space_marine_icons/sergeant_melee_research_1.tga]]
GameData["ui_info"]["screen_name_id"] = [[Ethereal honor blade upgrade]]
