...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Increase sight, keen sight and movement speed of the Cryptek]]
GameData["ui_info"]["icon_name"] = [[necron_icons/blinding_pillar_entity.tga]]
GameData["ui_info"]["screen_name_id"] = [[Effigy of oversight]]
