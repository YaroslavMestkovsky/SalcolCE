...
GameData["modifiers"]["modifier_01"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_enable.lua]])
...
GameData["requirements"]["required_2"]["global_addon_name"] = [[addons\inquisition_inquisitor_lord_psychic_aid_addon.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\global_required_addon.lua]])
GameData["requirements"]["required_3"]["global_addon_name"] = [[addons\inquisition_inquisitor_lord_psychic_aid_addon.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the Inquisitor lord to provide a shield to the land raider daemonhunter once he gets on.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The shield will require the full attention of the inquisitor lord to be mantained so most unnecessary movements will be disabled]]
...
GameData["ui_info"]["screen_name_id"] = [[Aid: Machine Spirit]]
