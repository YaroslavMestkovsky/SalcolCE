...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemon_fiend]]
...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_slaanesh_4_favoured_daemonette_attack_speed]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_slaanesh_4_favoured_daemonette_attack_speed]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Fiends of Slaanesh's desire for torture has brought this creature to smell the enemies blood from afar]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_fiend]]
GameData["ui_info"]["screen_name_id"] = [[Army of Slaanesh: Slaanesh's Fiend Perceptions]]
