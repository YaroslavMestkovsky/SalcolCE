...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[daemon_keeper_of_secrets]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Reduce the cost of all Keeper Of Secrets]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Requires tier 3]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_allure_kos_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Herald of the prince of pleasure]]
