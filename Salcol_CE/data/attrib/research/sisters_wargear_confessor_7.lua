...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Increase the recharge rate of all skills.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also adds a little health]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/holosuit_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Clear mind]]
