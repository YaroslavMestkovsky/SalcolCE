...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_daemons_army_of_tzeentch.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\addon_daemons_army_of_tzeentch.lua]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Screamers completely lose their mind and simply attack the enemy while emitting endless screams]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_screamer_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Tzeentch: Screamer Noise]]
