...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[sisters_knife_missionary]]
...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[sisters_archoflagellant_cutting_claws]]
...
GameData["modifiers"]["modifier_03"]["target_type_name"] = [[sisters_assassin_weapon]]
...
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[sisters_callidus_ctanphase_sword]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Increase the damage caused by melee weapons of all inquisitorial infantry, affecting:]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[T0 - Canoness, Missionary, ]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[T1 - Almoness, Archo Flagellant, Assassin, Callidus Assassin, Ordo Hereticus Inquisitor]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[T2 - /]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[T3 - Nunciate Superior, Throne of Judgement]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[T4 - /]]
GameData["ui_info"]["help_text_list"]["text_07"] = [[T5 - /]]
GameData["ui_info"]["icon_name"] = [[sisters_icons/research_crusade_seal]]
GameData["ui_info"]["screen_name_id"] = [[Crusader seals]]
