...
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Further increase the durability of all infantry units by 10%]]
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_research_guardsmen_health2]]
GameData["ui_info"]["screen_name_id"] = [[Improved  Battle Armor]]
