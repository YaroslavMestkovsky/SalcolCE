...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_khorne_2_flesh_hound_life_leech]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_khorne_2_flesh_hound_life_leech]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Bloodletters become obsessionated with their own bloodthirst. Consequently, they will become more likely to cause huge bloodsheds]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_bloodletter_elites_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Khorne: Bloodletter Damage]]
