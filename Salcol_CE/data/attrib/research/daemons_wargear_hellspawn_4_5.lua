...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemons_firebolt_hellspawn]]
...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[daemons_wargear_hellspawn]]
...
GameData["modifiers"]["modifier_03"]["target_type_name"] = [[daemons_firebolt_hellspawn]]
...
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[daemons_wargear_hellspawn]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\daemons_wargear_hellspawn_4_4.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["is_display_requirement"] = true 
GameData["requirements"]["required_3"]["research_name"] = [[research\daemons_wargear_hellspawn_4_4.lua]]
GameData["time_cost"] = Reference([[tables\time_cost_table.lua]])
GameData["time_cost"]["cost"]["population"] = 900
GameData["time_cost"]["time_seconds"] = 10
GameData["ui_hotkey_name"] = [[hotkey_f]]
GameData["ui_index_hint"] = 12
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[Further greatly increase the damage and attack speed of the hellspawn with both artillery and direct bolts]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also unlock a temporary active skill that, in exchange for heavy power usages, can easily wipe out armies and bases from afar.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[The skill itself is higly inaccurate and may cause extreme friendly fire]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_daemonfire_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Infernal daemonic fire V]]
