...
GameData["requirements"]["required_2"]["research_name"] = [[research\daemons_greater_gift_bloodthirster_speed.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["is_display_requirement"] = true 
GameData["requirements"]["required_3"]["research_name"] = [[research\daemons_greater_gift_bloodthirster_speed.lua]]
GameData["requirements"]["required_4"] = Reference([[requirements\required_research]])
GameData["requirements"]["required_4"]["research_name"] = [[daemons_mark_khorne]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow bloodthirsters to use the "boundless wrath" ability, which deals lethal damages to all infantry types at the targeted spot]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_bloodthirster_3.tga]]
