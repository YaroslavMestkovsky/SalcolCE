...
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Health of all vehicles is further increased by 6%]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Also, Hellions health is further increased by 4%]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Lastly, grant all vehicles other than Araspida improved shields to reduce incoming ranged damage]]
