...
GameData["requirements"]["required_2"]["research_name"] = [[eldar_wargear_avatar_aura_global_morale.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Globally increase the morale regeneration of all friendly infantry.]]
...
GameData["ui_info"]["screen_name_id"] = [[Global aura: Morale regeneration]]
