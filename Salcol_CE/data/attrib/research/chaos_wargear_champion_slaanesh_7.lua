...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The champion will dedicate himself to the cult of Slaanesh with renewed ambition]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Health and health regeneration are increased due to the new flow of warp power]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Also recruitment time is reduced]]
...
GameData["ui_info"]["screen_name_id"] = [[Initialization to the god]]
