...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Increase the range of all vehicle weapons]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[tau_icons/vehicle_range_research]]
GameData["ui_info"]["screen_name_id"] = [[Advanced Vehicle Targeting Systems I]]
