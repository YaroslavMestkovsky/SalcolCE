...
GameData["ui_info"]["help_text_list"]["text_03"] = [[First of two possible upgrades]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_damage_1.tga]]
GameData["ui_info"]["screen_name_id"] = [[Unbearable wrath I]]
