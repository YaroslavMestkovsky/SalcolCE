...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Equip a very long belt of sinew and bone that can easily torn apart any soldier from a distance]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Has a high chance to stun and cause incessant bleedings upon each landed hit]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 130-238]]
...
GameData["ui_info"]["screen_name_id"] = [[Whip]]
