...
GameData["requirements"]["required_5"]["research_name"] = [[research\necron_wargear08.lua]]
GameData["requirements"]["required_6"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_6"]["research_name"] = [[research\necron_wargear09.lua]]
GameData["requirements"]["required_7"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_7"]["research_name"] = [[research\necron_wargear10.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Replace the melee weapon of the Necron Lord with an Entropy Staff]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- This staff temporarily reduces the armor and the speed of the victim with each attack]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210592]] -- - Requires - Hero: Level 6
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Requires all other wargears and Tier 3.]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[DPS: 240-375]]
