...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemon_daemonette_greater]]
...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_slaanesh_2_daemonette_attack_speed]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_slaanesh_2_daemonette_attack_speed]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Favoured Daemonettes' gain neverending pleasure from causing bloodsheds and their instinct mutates accordingly, allowing them to perceive even the smallest blood drops from a distance]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_daemonette_greater_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Slaanesh: Favoured Daemonette Perceptions]]
