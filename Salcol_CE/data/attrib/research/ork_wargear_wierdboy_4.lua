...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Improves the sight and keen sight (minor) of all boyz and commanders]]
GameData["ui_info"]["icon_name"] = [[ork_icons/tougher_orks_research_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Orky instinct]]
