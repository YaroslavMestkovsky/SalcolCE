...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[guard_infantry_guardsmen_rider_sergeant]]
...
GameData["modifiers"]["modifier_05"]["target_type_name"] = [[guard_leaders_commissar_cadet]]
...
GameData["modifiers"]["modifier_06"]["target_type_name"] = [[guard_leaders_commissar_leader]]
...
GameData["modifiers"]["modifier_07"]["target_type_name"] = [[guard_leaders_field_medic_leader]]
...
GameData["modifiers"]["modifier_08"]["target_type_name"] = [[guard_leaders_priest]]
...
GameData["modifiers"]["modifier_09"]["target_type_name"] = [[guard_leaders_psyker]]
...
GameData["modifiers"]["modifier_10"]["target_type_name"] = [[guard_leaders_vox]]
...
GameData["modifiers"]["modifier_11"]["target_type_name"] = [[guard_infantry_guardsmen_sergeant]]
...
GameData["modifiers"]["modifier_13"]["target_type_name"] = [[guard_leaders_captain]]
...
GameData["modifiers"]["modifier_14"]["target_type_name"] = [[guard_leaders_colonel]]
...
GameData["modifiers"]["modifier_15"]["target_type_name"] = [[guard_leaders_lieutenant]]
...
GameData["modifiers"]["modifier_17"]["target_type_name"] = [[guard_leaders_psyker_advance_sp]]
GameData["modifiers"]["modifier_17"]["value"] = 1.149999976
GameData["modifiers"]["modifier_18"] = Reference([[modifiers\morale_maximum_player_modifier.lua]])
GameData["modifiers"]["modifier_18"]["value"] = 1.200000048
GameData["modifiers"]["modifier_19"] = Reference([[modifiers\max_leaders_squad_modifier.lua]])
GameData["modifiers"]["modifier_19"]["shield_of_faith"] = false
GameData["modifiers"]["modifier_19"]["target_type_name"] = [[guard_squad_command_squad]]
GameData["modifiers"]["modifier_19"]["value"] = 2
GameData["modifiers"]["modifier_20"] = Reference([[modifiers\max_leaders_squad_modifier.lua]])
GameData["modifiers"]["modifier_20"]["shield_of_faith"] = false
GameData["modifiers"]["modifier_20"]["target_type_name"] = [[guard_squad_command_squad_colonel]]
GameData["modifiers"]["modifier_20"]["value"] = 2
GameData["modifiers"]["modifier_21"] = Reference([[modifiers\max_leaders_squad_modifier.lua]])
GameData["modifiers"]["modifier_21"]["shield_of_faith"] = false
GameData["modifiers"]["modifier_21"]["target_type_name"] = [[guard_squad_command_squad_psykers]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Increase the morale and morale of all squads by 20%]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Also increase the loadout of command squads by +2]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Lastly, increase the health of all squad leaders, commanders and Commissar Cadets by 15%]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Allow the General to issue a deterrent to all enemy forces, wrecking their morale over time.]]
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_uncommon_valor.tga]]
