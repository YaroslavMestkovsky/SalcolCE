...
GameData["requirements"]["required_1"]["research_name"] = [[chaos_wargear_god_khorne_9.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Bloodthirster seeks more different challenges and becomes able to feel other daemons as well]]
...
GameData["ui_info"]["screen_name_id"] = [[Seek out heroes II]]
