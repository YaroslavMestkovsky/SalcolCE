...
GameData["requirements"]["required_3"]["research_name"] = [[chaos_mark_khorne_research]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Cultists will be able to worship Slaanesh, granting movement speed bonuses to all Chaos units. Icon Bearers will project an aura of speed and increased morale. Allows Slaanesh specific spells for the Chaos Sorcerer]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Also increase the morale damage dealt by all CSM infantry and vehicles]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18100092]] -- - Allows: Champion of Slaanesh (and the ascension into the Keeper of Secrets) and Dirge Casters research for the Chaos Land Raider.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$18100093]] -- - Disallows: Other Gods specific units and Khorne Shrines and abilities
GameData["ui_info"]["help_text_list"]["text_06"] = [[$18100113]] -- - Incompatible with all other Marks. WARNING!!! Choosing multiple Marks results in restricting all Greater Daemons, Champions, and Mark specific enemies for use.
