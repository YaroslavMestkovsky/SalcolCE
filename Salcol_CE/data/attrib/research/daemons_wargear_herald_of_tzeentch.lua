...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[daemon_lord_of_change]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Reduce the cost of all lord of changes]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Requires Tier 3]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_lord_of_change_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Herald of the changer of ways]]
