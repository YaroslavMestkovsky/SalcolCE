...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16002184]] -- - With Hatred, each additional Lost Soul present successively increases the sight range of all.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16002185]] -- - This gift rises the cost and drastically rises the requisition time of Lost Souls.
