...
GameData["requirements"]["required_10"]["research_name"] = [[research\eldar_vehicle_ability_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Provide 4 health regeneration per second to all non walker vehicles]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Also further increase their health by 5%]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Further increase the health of all walkers by 8%]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Also grant 3 additional health regeneration]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/holofield_icon2]]
GameData["ui_info"]["screen_name_id"] = [[Vehicle Upgrades II]]
