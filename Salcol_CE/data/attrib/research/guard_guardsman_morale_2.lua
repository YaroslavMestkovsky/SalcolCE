...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Increase the morale of all infantry squads by 25%]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Increase the morale recovery of all infantry squads by 25%]]
