...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_mark_undivided]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_mark_undivided]]
GameData["time_cost"] = Reference([[tables\time_cost_table.lua]])
GameData["time_cost"]["cost"]["population"] = 240
GameData["time_cost"]["time_seconds"] = 6
GameData["ui_hotkey_name"] = [[hotkey_j]]
GameData["ui_index_hint"] = 15
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Instill the depest terror in the heart of the enemies that look at at the prince.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- They will be unable to move and will not obey any issued order.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Requires Tier 3]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_wargear_angron_soul_rending.tga]]
GameData["ui_info"]["screen_name_id"] = [[Terrific aura]]
