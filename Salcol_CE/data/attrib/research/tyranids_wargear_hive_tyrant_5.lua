...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the tyrant to charge at the enemy, dealing very good damage and knockback]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Speed is also increased dramatically for the whole charge duration]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_leap.TGA]]
