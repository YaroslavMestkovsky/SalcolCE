...
GameData["requirements"]["required_2"]["research_name"] = [[eldar_laughing_god_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Globally increase the capture speed of all infantry types.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Also affects the allies infantry units.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- It is active as long as the Laughing god stands.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Requires Tier 4]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/great_webway_shroud_research_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Global aura: Capture speed]]
