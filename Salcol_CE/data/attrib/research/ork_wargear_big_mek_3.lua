...
GameData["requirements"]["required_5"]["research_name"] = [[commander_level7_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The directives of the Big Mek make prodution processes very fasta in all nearby buildings]]
GameData["ui_info"]["icon_name"] = [[ork_icons/ability_gargant_repair_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Assemblin' master]]
