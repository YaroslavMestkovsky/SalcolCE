...
GameData["requirements"]["required_2"]["research_name"] = [[eldar_wargear_laughing_god_aura_global_reinforce_speed.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Globally increase the recruit speed of all buildings.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Also affects the allies' ones.]]
...
GameData["ui_info"]["screen_name_id"] = [[Global aura: Recruit speed]]
