...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Increase the damage of Stealth Suits Burst Cannons by 100%]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Increase the melee damage of Stealth Suits by 200%]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Increase the Fusion Blaster of all Stealth Suits by 20%]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Also affects XV25 Stealth Suits]]
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_stealth_suit_damage_icon]]
GameData["ui_info"]["screen_name_id"] = [[Stealth Suit Weaponry Enhancement]]
