...
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16003525]] -- - Order all selected squads to eat the bodies of fallen units in a 100m radius. Permanently increase the health of all units of the same type as the one who gets to eat. (HP bonus cap 1000. Cannibalize speed x5)
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16003526]] -- - Order all selected squads to eat the bodies of fallen units in a 100m radius. Permanently increase the health of all units of the same type as the one who gets to eat. (HP bonus cap 2000. Cannibalize speed x5)
GameData["ui_info"]["help_text_list"]["text_07"] = [[$16003527]] -- - Order all selected squads to eat the bodies of fallen units in a 100m radius. Permanently increase the health of all units of the same type as the one who gets to eat. (HP bonus cap 3000. Cannibalize speed x5)
