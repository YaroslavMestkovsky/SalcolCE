...
GameData["time_cost"]["cost"]["population"] = 135
GameData["time_cost"]["time_seconds"] = 2
GameData["ui_hotkey_name"] = [[hotkey_d]]
GameData["ui_index_hint"] = 11
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[Increase the health, health regeneration and damage protection of the hellspawn, increasing it's survivability a lot]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_spell_sacrifice_research_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Strengthened daemonic link I]]
