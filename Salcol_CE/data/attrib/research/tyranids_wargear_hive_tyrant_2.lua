...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The thickness of the Hive Tyrant's natural armour is increased a lot, offering great protection]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Increases health]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_carapace.TGA]]
GameData["ui_info"]["screen_name_id"] = [[Scaled carapace]]
