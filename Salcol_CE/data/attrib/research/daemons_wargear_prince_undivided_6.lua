...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Allow to passively cast a flaming aura around that engulfs all enemies within.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Requires Tier 2]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_flame_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Blazing flame]]
