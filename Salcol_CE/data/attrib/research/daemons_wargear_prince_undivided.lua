...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Increase damage, health, health regeneration, speed and skill recharge rate of daemons commanders and monsters]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- The applied buff's strength is based on the number of obelisk (their tier does not make any difference)]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Requires Tier 2]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/mark_of_undivided.tga]]
GameData["ui_info"]["screen_name_id"] = [[Marks of chaos undivided]]
