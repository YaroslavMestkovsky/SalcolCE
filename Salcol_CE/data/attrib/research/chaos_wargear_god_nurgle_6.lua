...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[chaos_guo]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Replace the current sword with a giant mace that is very effective against armored targets and infantry swarms.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[All enemies that are hit by this weapon will also be corrupted and suffer more damages for a duration.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Also a corrosion effect is applied, causing the enemy flesh to be eaten away.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 130-260]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[$0]]
GameData["ui_info"]["icon_name"] = [[space_marine_icons/wargear17_thunderhammer]]
GameData["ui_info"]["screen_name_id"] = [[Unholy mace of desecration]]
