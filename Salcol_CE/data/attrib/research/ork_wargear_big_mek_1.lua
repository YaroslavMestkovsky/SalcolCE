...
GameData["requirements"]["required_6"]["research_name"] = [[ork_research_warboss_ranged_1.lua]]
...
GameData["requirements"]["required_7"]["research_name"] = [[ork_research_warboss_ranged_1.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Replace the current ranged weapon with a deff gun.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Deff guns are effective against all armour types, but require a setup time]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 225-300]]
GameData["ui_info"]["icon_name"] = [[ork_icons/kustom_force_field.tga]]
GameData["ui_info"]["screen_name_id"] = [[Deff gun]]
