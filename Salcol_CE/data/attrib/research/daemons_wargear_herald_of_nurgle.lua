...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Reduce the cost of all Great Unclean Ones]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Requires tier 3]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_great_unclean_one_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Herald of the plague lord]]
