...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Causes the spell to deal more damage]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Radically improve the relative spell in all aspects, but dramatically increase the recharge time]]
...
GameData["ui_info"]["screen_name_id"] = [[Upgrade spell: Lightning Arc]]
