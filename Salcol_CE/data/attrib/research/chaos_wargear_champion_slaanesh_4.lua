...
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[chaos_squad_lord_slaanesh]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This particular rune confers to the wearer unparalleled perceptions but will sometimes cloud the mind of the wearer.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[More morale damage will be suffered in exchange for heavy sight, keen sight and speed bonuses.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/mark_of_slaanesh.tga]]
GameData["ui_info"]["screen_name_id"] = [[Rune of Slaanesh]]
