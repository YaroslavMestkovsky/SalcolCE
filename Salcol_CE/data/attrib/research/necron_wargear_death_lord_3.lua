...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Gives minor buffs to all necron units around the map while the death lord is standing]]
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_siege_research_icon_old.tga]]
GameData["ui_info"]["screen_name_id"] = [[Green influences]]
