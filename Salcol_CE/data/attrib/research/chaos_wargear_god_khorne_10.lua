...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Equip a huge axe that can easily annihilate any armored target and infantry swarms]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The weapon is so heavy that the movement speed of the Bloodthirsterer will drop down terribly]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 450-1500]]
...
GameData["ui_info"]["screen_name_id"] = [[Colossal axe]]
