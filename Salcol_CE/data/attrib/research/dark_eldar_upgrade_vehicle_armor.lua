...
GameData["modifiers"]["modifier_13"]["target_type_name"] = [[dark_eldar_vehicle_reaver]]
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Health of all vehicles is increased by 6%]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Also, Hellions health is increased by 4%]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Lastly, grant all vehicles other than Araspida shields to reduce incoming ranged damage]]
