...
GameData["requirements"]["required_2"]["research_name"] = [[eldar_khaine_research_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Globally deal overtime damage to all enemy infantry types.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- In most cases it will just reduce the health regeneration.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- It is active as long as the Avatar stands.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Requires Tier 5]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/heart_of_khaine.tga]]
GameData["ui_info"]["screen_name_id"] = [[Global aura: Fire]]
