...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Brotherhood Champion incites all his Battle-Brothers to fight until the end]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Health, damage and morale of all Grey Knights is increased for as long as the Brotherhood Champion stands.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$0]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/wargear07.tga]]
GameData["ui_info"]["screen_name_id"] = [[Aura of Valor]]
