...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the hellspawn to directly cast his bolts forward in order to efficiently attack nearby enemies within the line of sight]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[These attacks will not deal much damage, but they will deplete the target's armor at an astonishing rate, allowing great damages over a period of time]]
