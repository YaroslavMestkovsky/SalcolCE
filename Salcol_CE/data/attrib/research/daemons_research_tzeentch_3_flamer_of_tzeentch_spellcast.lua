...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_tzeentch_2_screamer_accuracy]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_tzeentch_2_screamer_accuracy]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Flamers of Tzeentch become obsessed with their flames, increasing the rate at which fire spells can be casted]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/flamer_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Tzeentch: Tzeentch's Flamer Spellcast]]
