...
GameData["modifiers"]["modifier_03"]["target_type_name"] = [[tyranids_lictor]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Increase the sight and keen sight of both the lictor alpha and other lictors]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_catalyst.TGA]]
GameData["ui_info"]["screen_name_id"] = [[Finer perceptions]]
