...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemons_squad_fiends]]
...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_slaanesh_5_fiend_of_slaanesh_keen_sight]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_slaanesh_5_fiend_of_slaanesh_keen_sight]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Fiend of Slaanesh become extremely violent and try to maim the enemy while keeping on a continuos stream of attacks]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_fiend]]
GameData["ui_info"]["screen_name_id"] = [[Army of Slaanesh: Slaanesh's Fiend Fury]]
