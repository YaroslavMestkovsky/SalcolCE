...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Enhance the damage resistence of all greater daemons and warp spawns]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[First of two possible upgrades]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_armour_1.tga]]
GameData["ui_info"]["screen_name_id"] = [[Warp protection I]]
