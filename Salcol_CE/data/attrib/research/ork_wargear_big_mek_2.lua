...
GameData["requirements"]["required_6"]["research_name"] = [[research\commander_level1_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The knoweledge of the Big Mek greatly helps creating and maintaining vehicles.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Globally increase the health and armour of all orky vehicles as long as the Big Mek stands]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[ork_icons/kustom_tellyporta_ability.tga]]
GameData["ui_info"]["screen_name_id"] = [[Orky tekky stuff]]
