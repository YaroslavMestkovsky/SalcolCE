...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The desire of spilling more blood brings the keeper of secrets' perceptions on a whole other league]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Visibly increase keen sight]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_kos_1.tga]]
GameData["ui_info"]["screen_name_id"] = [[Deviant pleasure]]
