...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemon_defiler_nurgle]]
...
GameData["modifiers"]["modifier_03"]["target_type_name"] = [[daemon_plague_bearer]]
...
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[daemon_defiler_nurgle]]
...
GameData["modifiers"]["modifier_06"]["target_type_name"] = [[daemon_squad_nurgling]]
GameData["modifiers"]["modifier_06"]["value"] = 3
GameData["modifiers"]["modifier_07"] = Reference([[modifiers\max_troopers_squad_modifier.lua]])
GameData["modifiers"]["modifier_07"]["target_type_name"] = [[daemon_squad_plague_bearers]]
...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_mark_nurgle]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_mark_nurgle]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Reduces by 10% the requisition and time cost of nurglings and plague bearers]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Increase the maximum loadout of nurglings by +3]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Increase the maximum loadout of plague bearers by +2]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Reduce reinforcement time by 25%]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/mark_of_nurgle.tga]]
GameData["ui_info"]["screen_name_id"] = [[General of Nurgle]]
