...
GameData["modifiers"]["modifier_10"]["target_type_name"] = [[necron_flayed_one_advance_sp]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Increase the power cost of Flayed Ones squads by 90]]
