...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_daemons_army_of_slaanesh.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\addon_daemons_army_of_slaanesh.lua]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Daemonettes become sanguinary creatures that feel pleasure from fighting any kind of enemy. Therefore, they become very keen on discovering any type of threat]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_daemonette_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Slaanesh: Daemonette Perceptions]]
