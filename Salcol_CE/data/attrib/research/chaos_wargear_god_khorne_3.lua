...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Bloodthirster drains the strength of the enemies]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[All enemy infantry will have reduced speed, accuracy and morale regeneration]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/mark_of_khorne]]
GameData["ui_info"]["screen_name_id"] = [[Syphon energy: Strength]]
