...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Unlock a spell that allows the sorcerer to reache into his enemy's mind,  causing an unsettling waking dream in which they ally themselves with the Dark Powers.]]
