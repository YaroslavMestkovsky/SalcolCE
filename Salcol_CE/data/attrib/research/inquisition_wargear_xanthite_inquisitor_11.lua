...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Increase armour and hp of the user]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also provide little knockback resistence and additional ranged damage mitigation]]
GameData["ui_info"]["icon_name"] = [[sisters_icons/sisters_wargear09]]
GameData["ui_info"]["screen_name_id"] = [[Warding sigil]]
