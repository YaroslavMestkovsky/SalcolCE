...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- This new crossbow deals great damage against infantry and vehicles.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- A great knockback and a variety of debuffs are applied on each succesfull hit]]
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_upgrade_xv8_flamer.tga]]
GameData["ui_info"]["screen_name_id"] = [[Mastercrafted crossbow]]
