...
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211376]] -- - Grants +10 meter range to AEonic Orb ability ranges per Amplification Generator Constructed, allowing AEonic Orbs to fire off abilities from very long distances.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18211359]] -- - CHOOSE WISELY! Only 3 amplification researches can be chosen.
