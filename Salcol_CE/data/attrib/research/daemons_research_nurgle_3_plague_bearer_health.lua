...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_nurgle_2_nurgling_health_regen]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_nurgle_2_nurgling_health_regen]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Plague Bearers start inflicting their bodies any form of torture so that their body is stimulated to repair that part of the body, hardening it.]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_plaguebearer_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Nurgle: Plague Bearer Health]]
