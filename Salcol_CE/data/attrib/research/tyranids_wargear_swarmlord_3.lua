...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Hive Mind will constantly support the Swarmlord with the Reveal ability]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Sight and keen are drastically increased]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons\i_catalyst.TGA]]
GameData["ui_info"]["screen_name_id"] = [[Emissary of the Hive Mind: Reveal]]
