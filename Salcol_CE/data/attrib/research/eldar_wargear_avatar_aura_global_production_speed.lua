...
GameData["time_cost"]["time_seconds"] = 400
GameData["ui_hotkey_name"] = [[hotkey_g]]
GameData["ui_index_hint"] = 13
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Globally increase production speed.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Also affects all allied structures.]]
...
GameData["ui_info"]["icon_name"] = [[eldar_icons/eldar_wargear2_rune_doom.tga]]
GameData["ui_info"]["screen_name_id"] = [[Global aura: Production speed]]
