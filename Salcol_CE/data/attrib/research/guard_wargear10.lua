...
GameData["requirements"]["required_11"] = Reference([[requirements\global_required_addon]])
GameData["requirements"]["required_11"]["global_addon_name"] = [[addons/addon_guard_hq_2]]
