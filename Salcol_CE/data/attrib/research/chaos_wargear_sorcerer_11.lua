...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the Sorcerer to hit the ground with is weapon while casting an earthquake-like spell]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[All nearby units are cast aside with great force and impressive damages]]
...
GameData["ui_info"]["screen_name_id"] = [[Pulse of disruption]]
