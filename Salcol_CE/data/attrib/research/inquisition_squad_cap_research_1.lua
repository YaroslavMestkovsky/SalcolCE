...
GameData["requirements"]["required_1"]["research_name"] = [[inquisition_squad_cap_research]]
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons\schematic_grey_knight_interceptor_icon.tga]]
