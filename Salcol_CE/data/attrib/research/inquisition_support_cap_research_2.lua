...
GameData["requirements"]["required_1"]["research_name"] = [[inquisition_support_cap_research_1]]
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons\schematic_predator_icon.tga]]
