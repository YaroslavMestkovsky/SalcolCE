...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Allows vision of the whole map for a short period of time.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Infiltrated units and  buildings will be revealed as well for the whole duration]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Requires Tier 5]]
