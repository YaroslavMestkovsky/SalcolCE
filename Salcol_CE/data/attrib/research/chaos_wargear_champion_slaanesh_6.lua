...
GameData["requirements"]["required_1"]["research_name"] = [[chaos_wargear_champion_slaanesh_4.lua]]
GameData["requirements"]["required_2"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_2"]["research_name"] = [[chaos_wargear_champion_slaanesh_4.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The sight of the Champion of Slaanesh is enough to pertify even the most stalwart warriors.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Enemies who lose their hope will suffer terrible morale damages and be unable either to move or attack]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_daemonette_scream.tga]]
GameData["ui_info"]["screen_name_id"] = [[Petrifying presence]]
