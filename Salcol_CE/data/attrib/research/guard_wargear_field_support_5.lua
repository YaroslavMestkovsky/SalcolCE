...
GameData["requirements"]["required_2"]["research_name"] = [[research\guard_wargear_field_support_4.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["research_name"] = [[research\guard_wargear_field_support_4.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The field lieutenant unlocks a skill that allows him to place minefields very fast.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[It will cost some resources, but it allows to leave a static trap.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Very useful ability when reinforcing positions.]]
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_mines]]
