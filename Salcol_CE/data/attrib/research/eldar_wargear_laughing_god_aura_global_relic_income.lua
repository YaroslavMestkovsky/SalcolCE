...
GameData["requirements"]["required_2"]["research_name"] = [[eldar_wargear_laughing_god_aura_global_relic_total.lua]]
...
GameData["time_cost"]["time_seconds"] = 390
GameData["ui_hotkey_name"] = [[hotkey_e]]
GameData["ui_index_hint"] = 3
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[Globally increase the relic income and marginally other resource incomes as well.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also affects your allies.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[It is active as long as the Laughing god stands.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Doesn't need to be repurchased if the Laughing god dies.]]
GameData["ui_info"]["icon_name"] = [[npc/relic_inc_research2]]
GameData["ui_info"]["screen_name_id"] = [[Global aura: Relic income]]
