...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Unlocks a skills that allows the Hive Tyrant to throw an incredible amount of spores at a designed location]]
...
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_spore_launch.tga]]
