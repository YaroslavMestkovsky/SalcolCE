...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210565]] -- - The Librarian learns to use the spell "Smite", an offensive ability that damages enemy infantry with an area of effect.
