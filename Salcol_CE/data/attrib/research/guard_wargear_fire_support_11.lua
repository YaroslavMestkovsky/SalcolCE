...
GameData["requirements"]["required_3"]["research_name"] = [[research\commander_level1_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Permanently unlock a new ability for the Fire Support Lieutenant]]
