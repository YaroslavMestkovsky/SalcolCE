...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18211365]] -- - Grants 1% health, health regeneration, construction speed, and repair speed bonus per Amplification Generator constructed to all Builder Scarabs.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18211359]] -- - CHOOSE WISELY! Only 3 amplification researches can be chosen.
