...
GameData["time_cost"]["cost"]["souls"] = 220
GameData["time_cost"]["time_seconds"] = 2
GameData["ui_hotkey_name"] = [[hotkey_f]]
GameData["ui_index_hint"] = 12
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[The haemonculus enslaves enemy prisoners directly on the battlefield,]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[making them able to work for the dark eldar side]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[As the enemy sees something so cruel, their morale will be crushed]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Speed up the creation of upgrades within the Haemonculus]]
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons\torture_pit_icon]]
GameData["ui_info"]["screen_name_id"] = [[Torture master]]
