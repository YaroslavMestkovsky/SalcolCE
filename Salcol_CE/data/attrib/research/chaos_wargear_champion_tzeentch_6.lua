...
GameData["requirements"]["required_1"]["research_name"] = [[chaos_wargear_champion_tzeentch_4.lua]]
GameData["requirements"]["required_2"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_2"]["research_name"] = [[chaos_wargear_champion_tzeentch_4.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the Sorcerer lord to passively infuse the weapons of nearby units with warp energies]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Affected weapons have improved damage, armour piercing, range and accuracy]]
...
GameData["ui_info"]["screen_name_id"] = [[Local warp infusion]]
