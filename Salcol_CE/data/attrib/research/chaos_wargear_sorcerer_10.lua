...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Sorceror will absorb the power of freshly spilled blood nearby.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[That blood can be released at once as an offering to the chaos gods in exchance for favours.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[When that happens, all nearby enemies will incur in the overwhelming fury of the chaos gods]]
...
GameData["ui_info"]["screen_name_id"] = [[Offering of revenge]]
