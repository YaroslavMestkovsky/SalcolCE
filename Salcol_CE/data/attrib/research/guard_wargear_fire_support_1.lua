...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Upgrade the melee weapon]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[DPS: 62-111]]
GameData["ui_info"]["icon_name"] = [[guard_icons/guard_wargear11]]
GameData["ui_info"]["screen_name_id"] = [[Sharpened sword]]
