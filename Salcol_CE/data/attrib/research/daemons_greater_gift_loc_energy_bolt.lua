...
GameData["requirements"]["required_2"]["research_name"] = [[research\daemons_greater_gift_loc_displacement_bolt.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["is_display_requirement"] = true 
GameData["requirements"]["required_3"]["research_name"] = [[research\daemons_greater_gift_loc_displacement_bolt.lua]]
GameData["requirements"]["required_4"] = Reference([[requirements\required_research_either]])
GameData["requirements"]["required_4"]["research_name_either"] = [[research\daemons_mark_tzeentch.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the lord of change to cast the "Immaterium bolt" spell, which deals incredible damages against all armour ratings]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_loc_2.tga]]
