...
GameData["requirements"]["required_2"]["research_name"] = [[research\guard_wargear18.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["research_name"] = [[research\guard_wargear18.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Equip the fire support lieutenant with frag grenades of higher quality, effective against infantry and buildings]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also allows to throw even more bombs when using frag grenades]]
GameData["ui_info"]["icon_name"] = [[guard_icons/incendiary_bombs_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Frag-phosphor grenade mix]]
