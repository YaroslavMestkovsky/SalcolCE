...
GameData["requirements"]["required_1"]["research_name"] = [[chaos_wargear_god_khorne_choice_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[Wrath of Khorne are Bloodthirsters specialised in haunting the worthiest enemy commanders]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Incompatible with the sixth and third hosts]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/gracious_alacrity_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Third host: Wrath of Khorne]]
