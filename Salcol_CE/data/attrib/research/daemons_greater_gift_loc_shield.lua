...
GameData["requirements"]["required_2"]["research_name"] = [[research\daemons_greater_gift_loc_energy_bolt.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["is_display_requirement"] = true 
GameData["requirements"]["required_3"]["research_name"] = [[research\daemons_greater_gift_loc_energy_bolt.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the lord of change to cast a very resilient shield around itself, blocking off all damages until depletion]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_loc_3.tga]]
GameData["ui_info"]["screen_name_id"] = [[Force field]]
