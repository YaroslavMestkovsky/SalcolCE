...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemon_squad_flesh_hound]]
...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_daemons_army_of_khorne.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\addon_daemons_army_of_khorne.lua]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Flesh hounds develop uncontrollable rage, which allows them to deal heavier damages]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_flesh_hound_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Khorne: Flesh Hound Damage]]
