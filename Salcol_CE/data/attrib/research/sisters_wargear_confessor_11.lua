...
GameData["requirements"]["required_2"]["research_name"] = [[research\sisters_divine_retribution_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The confessor automatically casts upon himself alone a weaker version of the Divine Retribution ability]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[This ability will be active for 10 seconds every 20 seconds]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Units affected by this shield recieve slightly less damage and deal 25 damages to other melee attackers only]]
GameData["ui_info"]["icon_name"] = [[sisters_icons\research_divine_retribution.tga]]
GameData["ui_info"]["screen_name_id"] = [[Divine Emperor retribution]]
