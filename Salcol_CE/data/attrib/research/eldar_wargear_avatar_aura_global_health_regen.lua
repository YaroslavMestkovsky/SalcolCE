...
GameData["requirements"]["required_2"]["research_name"] = [[eldar_wargear_avatar_aura_global_health.lua]]
GameData["time_cost"] = Reference([[tables\time_cost_table.lua]])
GameData["time_cost"]["cost"]["faith"] = 0
GameData["time_cost"]["cost"]["power"] = 1600
GameData["time_cost"]["cost"]["requisition"] = 1600
GameData["time_cost"]["cost"]["souls"] = 0
GameData["time_cost"]["time_seconds"] = 350
GameData["ui_hotkey_name"] = [[hotkey_q]]
GameData["ui_index_hint"] = 1
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Globally increase the health regeneration of all friendly infantry]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Also affects the allies infantry units.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- It is active as long as the Avatar stands.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Requires Tier 3]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/great_webway_building_strengthen_research_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Global aura: Health regeneration]]
