...
GameData["requirements"]["required_2"]["research_name"] = [[research\daemons_greater_gift_kos_invisibility.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["is_display_requirement"] = true 
GameData["requirements"]["required_3"]["research_name"] = [[research\daemons_greater_gift_kos_invisibility.lua]]
GameData["requirements"]["required_4"] = Reference([[requirements\required_research]])
GameData["requirements"]["required_4"]["research_name"] = [[daemons_mark_slaanesh]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Distract all nearby enemies, making them unable to perform any action for some time]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[On the other hand, affected squads' morale is partially restored]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_kos_3.tga]]
GameData["ui_info"]["screen_name_id"] = [[Lustful diversion]]
