...
GameData["modifiers"]["modifier_05"]["target_type_name"] = [[necron_pariah]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Further increase the movement speed of all infantry units by 10%]]
