...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Further upgrade the skill, making it deadly against infantry and buildings alike.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- As range is increased as well, the recharge speed drops down significantly]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Requires Tier 3.]]
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_antrigrav_research.tga]]
GameData["ui_info"]["screen_name_id"] = [[Upgrade spell: Green bolt]]
