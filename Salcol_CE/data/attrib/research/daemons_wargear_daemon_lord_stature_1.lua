...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemon_lord_stature]]
GameData["modifiers"]["modifier_01"]["shield_of_faith"] = nil
GameData["modifiers"]["modifier_02"] = Reference([[modifiers\enable_hardpoint_05.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the daemon lord stature to burn his enemies to ashes with the power of the daemon flames.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The new weapon is effective against all infantry types and morale]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 20-73]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_daemonfire_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Summon daemon fire]]
