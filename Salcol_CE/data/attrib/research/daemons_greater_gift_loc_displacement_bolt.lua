...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the lord of change to cast the "bolt of displacement" spell, which is very effective for breaking enemy formations from afar]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_loc_1.tga]]
