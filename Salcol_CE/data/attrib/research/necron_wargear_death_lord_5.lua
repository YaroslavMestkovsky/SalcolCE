...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Energy beacons will globally give minor bonuses to all necron infantry and commanders as well]]
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_solar_pulse_research_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Green forces]]
