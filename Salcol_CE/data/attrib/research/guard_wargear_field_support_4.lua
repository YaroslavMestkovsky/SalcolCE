...
GameData["ui_info"]["help_text_list"]["text_01"] = [[With this skill, the field command lieutenant can enstablish]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[a little barricade at a minimal requisition cost.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[It will not offer any protection, but it can be used to obstacle the enemy movements]]
GameData["ui_info"]["icon_name"] = [[npc/tanktrap2]]
GameData["ui_info"]["screen_name_id"] = [[Build tank traps]]
