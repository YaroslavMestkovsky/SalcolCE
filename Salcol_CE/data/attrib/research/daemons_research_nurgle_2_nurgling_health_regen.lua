...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_nurgle_1_nurgling_health]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_3"]["is_display_requirement"] = true 
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_nurgle_1_nurgling_health]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Nurglings become interested in parasites found on the planet's surface and test the surviving ones on themselves. Adding more creatures makes the ecosystem on their body more various and adaptable, increasing its regenerating capabilities]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_nurglings_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Nurgle: Nurgling Health Regeneration]]
