...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Equip a deadly axe that deals extra damages against commanders]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Can still kill many soldiers in a single blow]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 600-900]]
...
GameData["ui_info"]["screen_name_id"] = [[Axe of Slaughter]]
