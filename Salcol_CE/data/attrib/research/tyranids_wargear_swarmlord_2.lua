...
GameData["time_cost"]["cost"]["power"] = 2400
GameData["time_cost"]["time_seconds"] = 1
GameData["ui_hotkey_name"] = [[hotkey_w]]
GameData["ui_index_hint"] = 2
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$91761]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Hive Mind will constantly support the Swarmlord with the Meteorstrike ability]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Several large meteors will be launched near to the Swarmlord position]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: + 208-500]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons\meteor_bombardment]]
GameData["ui_info"]["screen_name_id"] = [[Emissary of the Hive Mind: Meteorstrike]]
