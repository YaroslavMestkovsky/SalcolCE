...
GameData["requirements"]["required_1"]["research_name"] = [[chaos_wargear_god_khorne_9_2.lua]]
GameData["requirements"]["required_2"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_2"]["is_display_requirement"] = true 
GameData["requirements"]["required_2"]["research_name"] = [[chaos_wargear_god_khorne_9_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Bloodthirster seeks absolute glory and identifies the worthiest of enemy opponents, living metal constructs and titans as well]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[In addition to preventing infiltration and revealing the enemy on the map, enhance applied debuffs:]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Reduced sight and keen sight]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Increased damage taken]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Continuous morale damages]]
...
GameData["ui_info"]["screen_name_id"] = [[Seek out heroes III]]
