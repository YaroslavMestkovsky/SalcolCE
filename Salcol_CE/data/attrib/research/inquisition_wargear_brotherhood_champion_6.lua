...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- This particular item gives damage reduction from all sources and health regeneration is given to the wearer.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Also enable the passive casting of an aura that weakens monsters and daemons]]
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons/tome_daemonica_1_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Liber daemonica]]
