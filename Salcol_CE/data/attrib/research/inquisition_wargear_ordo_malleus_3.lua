...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Greatly increase the maximum health and health regeneration of the Supreme Inquisitor Ordo Malleus]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18210590]] -- - Requires - Hero: Level 4
GameData["ui_info"]["icon_name"] = [[inquisition_icons/psychic_recovery_ability.tga]]
GameData["ui_info"]["screen_name_id"] = [[Psychic healing]]
