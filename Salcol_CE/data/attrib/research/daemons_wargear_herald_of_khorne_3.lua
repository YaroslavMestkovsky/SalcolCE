...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Allows a powerful blood pulse to be unleashed, dealing huge worldwide damage against all enemy infantry, while avoiding any daemonic being]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Requires tier 5]]
