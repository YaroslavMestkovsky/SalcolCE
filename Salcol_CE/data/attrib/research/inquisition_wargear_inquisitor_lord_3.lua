...
GameData["requirements"]["required_2"]["global_addon_name"] = [[addons\inquisition_inquisitor_lord_mage_sorceror_addon.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\global_required_addon.lua]])
GameData["requirements"]["required_3"]["global_addon_name"] = [[addons\inquisition_inquisitor_lord_mage_sorceror_addon.lua]]
GameData["requirements"]["required_3"]["is_display_requirement"] = true 
GameData["requirements"]["required_4"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_4"]["research_name"] = [[inquisition_psy_power_3.lua]]
GameData["requirements"]["required_5"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_5"]["research_name"] = [[inquisition_psy_power_6.lua]]
GameData["requirements"]["required_6"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_6"]["research_name"] = [[inquisition_psy_power_7.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Improve the banish, fireball and lightning ball spells and make them ultimate skills.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The cooldown becomes higher and shared between the three of them.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Upon usage, the morale will be completely depleted and no other spell can be casted until it is restored again]]
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons/tome_psykerpower_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[All-out apocalyptic casting]]
