...
GameData["time_cost"]["cost"]["power"] = 610
GameData["time_cost"]["time_seconds"] = 1
GameData["ui_hotkey_name"] = [[hotkey_f]]
GameData["ui_index_hint"] = 12
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18210762]] -- - Empowers the Cryptek with extended abilities of the C'tan gods.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18210772]] -- - Allows the Overseer to summon the Homeworld Portal.
GameData["ui_info"]["help_text_list"]["text_03"] = [[- While kept alive, Necron Warriors and Flayed Ones are free to produce but their building time is doubled]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Also, units next to the Cryptek are 10% more likely to resurrect and have increased health regeneration]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[$18210765]] -- - Increases the power cost of the Cryptek once researched.
