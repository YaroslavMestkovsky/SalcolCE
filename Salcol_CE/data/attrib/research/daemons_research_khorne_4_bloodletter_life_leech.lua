...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_khorne_3_bloodletter_damage]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_khorne_3_bloodletter_damage]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Bloodletters' Hellblades sap the strength of the enemy with each succesful blow, granting part of it to the wielder and the remaining part for itself]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_bloodletter_elites_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Khorne: Bloodletter Life Leech]]
