...
GameData["requirements"]["required_2"]["research_name"] = [[chaos_wargear_god_khorne_choice_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Bloodthirster becomes one of the eight hosts.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Bloodthirsters of Insensate Rage are Bloodthirsters that wield enormous axes that can easily annihilate any armoured target or swarms of units]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Incompatible with the third and eighth hosts]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[command_icons/possess]]
GameData["ui_info"]["screen_name_id"] = [[Sixth host: Bloodthirsters of Insensate Rage]]
