...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Final tier.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Allows the production of the Hierophant Bio Titan, Capillary Tower, and deadly final tier researches.]]
