...
GameData["modifiers"]["modifier_04"]["target_type_name"] = [[inquisition_grey_knight_champion_improved]]
...
GameData["modifiers"]["modifier_05"]["target_type_name"] = [[inquisition_grey_knight_champion_improved]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The Iron Halo creates a gravitic conversion field that dramatically reduces the impact and damage of all ranged weapons.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Damage coming from other sources is reduced only a little]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Requires Tier 3]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$0]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[sisters_icons/sisters_wargear_halo.tga]]
GameData["ui_info"]["screen_name_id"] = [[Iron Halo]]
