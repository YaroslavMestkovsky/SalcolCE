...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Enable even more daemonic flames to be unleashed against the enemies]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Daemonic flames are effective against infantry and morale.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Also buildings take good damages from this new weapon]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: + 80-160]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/daemonfire_research.tga]]
GameData["ui_info"]["screen_name_id"] = [[Daemonic fire]]
