...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Unlock a jump skill that allows to charge at the enemy or avoid obstacles in a short range]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Upon landing, enemy formations will most probably break and suffer good damage]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_infiltrate.TGA]]
GameData["ui_info"]["screen_name_id"] = [[Rush]]
