...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- All minor Kroot squads receive further +2 maximum loadout]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Krootox and Greater Knarloc receive further +1 max loadout]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Further reduce recruit time of all squads from the Kroot Shaping Center by 10%]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Further increase reinforce speed of all squads by 20%]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[$18111856]] -- - Second of two possible researches.
