...
GameData["requirements"]["required_1"] = Reference([[requirements\required_research_either]])
GameData["requirements"]["required_1"]["is_display_requirement"] = true 
GameData["requirements"]["required_1"]["research_name_either"] = [[research\daemons_research_favored1.lua]]
GameData["requirements"]["required_1"]["research_name_or"] = [[research\daemons_mark_undivided.lua]]
GameData["requirements"]["required_2"] = Reference([[requirements\global_required_addon.lua]])
GameData["requirements"]["required_2"]["global_addon_name"] = [[addons\addon_daemons_hq_1.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_research_either]])
GameData["requirements"]["required_3"]["research_name_either"] = [[research\daemons_research_favored1.lua]]
GameData["requirements"]["required_3"]["research_name_or"] = [[research\daemons_mark_undivided.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Warp the squad's members from the inside, causing no apparent change, but allowing them to cause some kind of retaliation upon death]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Researching this brings explosion chance from 0% to 33%]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/wildfire_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Death Feedback I]]
