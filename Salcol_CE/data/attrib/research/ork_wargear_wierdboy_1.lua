...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The frazzle ability will not affect units all around anymore, targeting only those directly faced by the Wierdboy]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[All damage is focused in a narrow cone, causing deadly damages against infantry and morale]]
