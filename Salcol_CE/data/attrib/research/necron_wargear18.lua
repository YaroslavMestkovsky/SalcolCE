...
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Surrounds the Cryptek with a lightning cloud that damages nearby enemy units over time.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18210765]] -- - Increases the power cost of the Cryptek once researched.
