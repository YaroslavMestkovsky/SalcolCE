...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Cryptek's body is covered by little scarabs that protect him against ranged damage while enhancing it's regenerating ability]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_wargear08.tga]]
GameData["ui_info"]["screen_name_id"] = [[Weakened necrodermis]]
