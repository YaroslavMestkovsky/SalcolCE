...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemon_squad_screamers]]
...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_tzeentch_3_flamer_of_tzeentch_spellcast]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_tzeentch_3_flamer_of_tzeentch_spellcast]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Flamers of Tzeentch compulsively create immense walls of fire to invest the enemy. Avoiding such attacks would never be possible for anyone.]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/flamer_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Tzeentch: Tzeentch's Flamer Accuracy]]
