...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[tyranids_termagant_max]]
GameData["modifiers"]["modifier_03"] = Reference([[modifiers\default_weapon_modifier_hardpoint1.lua]])
GameData["modifiers"]["modifier_03"]["shield_of_faith"] = false
GameData["modifiers"]["modifier_03"]["target_type_name"] = [[tyranids_gargoyle]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Improves the damage dealt of all Devourers used by Termagant and Gargoyles]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_devourer]]
GameData["ui_info"]["screen_name_id"] = [[Gaunt Devourer Weapon Effectiveness]]
