...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Some inquisitors are masters of psychic disciplines.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Reduces ability cooldowns by 20%]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Slightly imrpoves Health]]
...
GameData["ui_info"]["screen_name_id"] = [[Psychic Mastery]]
