...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[daemon_plague_bearer]]
...
GameData["requirements"]["required_1"]["research_name"] = [[daemons_research_nurgle_3_plague_bearer_health]]
...
GameData["requirements"]["required_3"]["research_name"] = [[daemons_research_nurgle_3_plague_bearer_health]]
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[Plague Bearers inflict terrible wounds to themselves when out of combat, making their body used to regenerating with more efficience in every moment]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_plaguebearer_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Nurgle: Plague bearer Health Regeneration]]
