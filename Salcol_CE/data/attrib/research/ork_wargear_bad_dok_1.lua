...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Increase the health of all bad dokz.]]
GameData["ui_info"]["icon_name"] = [[ork_icons/upgrade_blast_krak_kannon_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Dok shiny rags]]
