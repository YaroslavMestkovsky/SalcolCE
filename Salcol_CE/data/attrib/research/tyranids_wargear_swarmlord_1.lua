...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Hive Mind will constantly support the Swarmlord with the Sporestrike ability]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Several spore meteors will be launched near to the Swarmlord position]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16028304]] -- - Spore meteors damage and poison enemy targets at random locations.
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: + 100-300]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/acid_vomit_icon]]
GameData["ui_info"]["screen_name_id"] = [[Emissary of the Hive Mind: Sporestrike]]
