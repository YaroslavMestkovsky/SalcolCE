...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Consistently increase the armour of all shining spears]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/eldar_wargear06.tga]]
GameData["ui_info"]["screen_name_id"] = [[Aspect armour]]
