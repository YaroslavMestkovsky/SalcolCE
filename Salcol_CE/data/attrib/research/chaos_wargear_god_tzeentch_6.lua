...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Black Staff of Ahriman is an ornate Force weapon used by Ahzek Ahriman, Chaos Sorcerer of the Thousand Sons. It acts as a focus for his psychic energy, enabling him to call on a multitude of Chaos Psychic Powers]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[DPS: 31-63]]
...
GameData["ui_info"]["screen_name_id"] = [[Black Staff of Ahriman]]
