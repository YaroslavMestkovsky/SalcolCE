...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Allow the lictor alpha to order underground rippers where to dig underground tunnels and exits]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[These tunnels allow fast unit transport or can directly spawn other lictors]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[This skill can also be used offensively, making the ground crumble under the enemy army's feet.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Doing so will result in light damages to infantry and good damages to vehicles. Moreover, affected unit's speed is reduced.]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_tunnel_ability.tga]]
GameData["ui_info"]["screen_name_id"] = [[Underground excavation]]
