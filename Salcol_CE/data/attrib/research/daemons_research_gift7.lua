...
GameData["modifiers"]["modifier_16"] = Reference([[modifiers\morale_maximum_player_modifier.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16002173]] -- - If petitioned, all Lesser Daemons will receive further increased squad morale.
