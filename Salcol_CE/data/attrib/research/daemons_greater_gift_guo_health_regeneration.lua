...
GameData["requirements"]["required_2"]["research_name"] = [[daemons_mark_tzeentch]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Blighted creatures all over the great unclean one's body enter and fill any wound, aiding the regeneration process]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/greater_gift_guo_1.tga]]
GameData["ui_info"]["screen_name_id"] = [[Purulent flesh]]
