...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Unlock a soul-shock ability and allows soul portals to be casted by the haemonnculus]]
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons\soul_destructor]]
GameData["ui_info"]["screen_name_id"] = [[Soul conjurations]]
