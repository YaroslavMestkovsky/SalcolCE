...
GameData["requirements"]["required_2"]["research_name"] = [[research\inquisition_tome_alacrity_2.lua]]
...
GameData["requirements"]["required_5"]["squad_name"] = [[sbps\races\inquisition_daemonhunt\inquisition_squad_inquisitor_ordo_malleus.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022122]] -- + A tome that is highly sought after amongst those few privileged enough to know of it's existence. Though these tomes were heavily annointed after their discovery, their use nonetheless remains controversial as they were claimed from a coven of Tzeentch worshippers. Describes means by which an individual may attune their mind to written knowledge, allowing them to absorb information at a startling rate.  
