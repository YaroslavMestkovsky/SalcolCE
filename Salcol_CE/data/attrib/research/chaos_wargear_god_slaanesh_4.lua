...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Keeper of Secrets will gather some terrible truths to break the enemy morale]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Allows the Keeper of Secrets to reveal some dreadful ones and disrupt the enemy squads.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[The Keeper of Secrets is very pleased by the tragic effects of it's action and will fight with utmost passion for a good duration]]
...
GameData["ui_info"]["screen_name_id"] = [[Listen for secrets]]
