...
GameData["requirements"]["required_1"]["research_name"] = [[chaos_wargear_lord_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Makes daemon strength and berserk fury passive skills of the chaos lord.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Damage of the entire squad is dramatically increased, just like the damage taken is.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Also morale resistence of the attached squad is increased a lot]]
...
GameData["ui_info"]["screen_name_id"] = [[Bloodthirst]]
