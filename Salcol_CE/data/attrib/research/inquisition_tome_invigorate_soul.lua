...
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022131]] -- + Tome describes arcane practices believed to increase a psyker's mental stamina. Spells which were previously draining to the energies of a psyker will become much easier to project.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022132]] -- 
