...
GameData["requirements"]["required_6"]["research_name"] = [[research\ork_wargear10.lua]]
...
GameData["requirements"]["required_7"]["research_name"] = [[research\ork_wargear10.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Replace "powa o' waaagh" with an improved waaagh that dramatically augments the effectiveness of all those nearby]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[]]
GameData["ui_info"]["icon_name"] = [[ork_icons/waaagh_of_charge.tga]]
GameData["ui_info"]["screen_name_id"] = [[Waaagh o' charge!]]
