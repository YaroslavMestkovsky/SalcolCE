...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Cryptek becomes able to conjure a new spell: Green bolt]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[A green bolt is fired, dealing good damage and knockback]]
GameData["ui_info"]["icon_name"] = [[necron_icons/necron_antrigrav_research.tga]]
GameData["ui_info"]["screen_name_id"] = [[Learn spell: Green bolt]]
