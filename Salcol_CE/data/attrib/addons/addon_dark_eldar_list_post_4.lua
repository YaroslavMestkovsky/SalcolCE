...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_dark_eldar_list_post_3.lua]]
...
GameData["requirements"]["required_8"]["addon_name"] = [[addons\addon_dark_eldar_list_post_3.lua]]
