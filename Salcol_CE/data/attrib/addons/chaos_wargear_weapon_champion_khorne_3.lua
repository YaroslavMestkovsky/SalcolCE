...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_khorne_2.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_khorne_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Bloodfeeders are Daemon Weapons of Khorne, that often take the form of an axe and contain the bound essence of a raging Bloodthirster.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Anyone struck by these ever-thirsting weapons is immediately exsanguinated and reduced to a desiccated husk as their lifeblood is channeled into Khorne's realm as sustenance for his Juggernauts.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Woe betide anyone who wields a Bloodfeeder and dares not answer their call to feed ? for if the weapons go without this grisly harvest for long, they will gladly siphon away their wielder's blood instead.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 192-230]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_upgrade_angron_prince_sword.tga]]
GameData["ui_info"]["screen_name_id"] = [[Bloodfeeder]]
