...
GameData["ui_info"]["help_text_list"]["text_02"] = [[Main -          /]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Lateral -      Quad bolter]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Additional - Twin heavy bolter | Multi melta]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[]]
GameData["ui_info"]["icon_name"] = [[space_marine_icons/land_raider_prometheus_icon]]
GameData["ui_info"]["screen_name_id"] = [[Weapon set: Prometheus]]
