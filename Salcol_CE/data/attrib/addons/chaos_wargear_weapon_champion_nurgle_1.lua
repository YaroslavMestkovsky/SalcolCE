...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Plaguebringers harbor daemonic germs that are virulent enough to kill the toughest foe.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[DPS: 79-124]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_upgrade_nurgle.tga]]
GameData["ui_info"]["screen_name_id"] = [[Plaguebringer]]
