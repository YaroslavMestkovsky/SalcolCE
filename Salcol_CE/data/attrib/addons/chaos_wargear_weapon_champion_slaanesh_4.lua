...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_slaanesh_2.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_slaanesh_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This elegant blade is formed from a single shard of purest quicksilver hewn from Slaanesh's throne.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Its wielder is empowered to a near impossible level of swiftness, the sword darting, spinning and striking with a grace born of both divine perfection and murderous intent.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[The blade revels in bleeding its victims slowly, raking them with dozens of lightning-fast strikes and relishing the pain they cause.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 1000-1200]]
GameData["ui_info"]["icon_name"] = [[eldar_icons/bonesinger_ability_research_2_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Silvershard]]
