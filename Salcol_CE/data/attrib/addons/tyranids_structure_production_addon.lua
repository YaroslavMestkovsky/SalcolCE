...
GameData["requirements"]["required_2"]["structure_name"] = [[ebps\races\tyranids\structures\tyranids_carnifex_hive.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18211064]] -- - Speeds up the production rates of all structures 90m from the Capillary Vein by 10%.
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Having more Capillary Veins with this upgrade will grant increased bonuses]]
