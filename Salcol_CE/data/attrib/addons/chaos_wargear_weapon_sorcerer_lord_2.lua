...
GameData["requirements"]["required_2"]["mutually_exclusive_with"] = [[addons\chaos_wargear_weapon_sorcerer_lord_1.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Within the pages of this magical tome lie the secrets of every cantrip, incantation and spell ever conceived by Tzeentch.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Though the bearer of this grimoire has access to the infinite knowledge bound within, only Tzeentch himself could hope to master the full scope of its power.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 106-427]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/tome_daemonica_1_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Endless Grimoire]]
