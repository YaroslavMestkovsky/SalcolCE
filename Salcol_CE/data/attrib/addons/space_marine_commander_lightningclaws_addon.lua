...
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Incompatible with ranged weapon upgrades but keeps the storm bolter as ranged weapon]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 544-686]]
