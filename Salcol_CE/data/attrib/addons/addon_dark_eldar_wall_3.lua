...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_dark_eldar_wall_2.lua]]
...
GameData["requirements"]["required_3"]["addon_name"] = [[addons\addon_dark_eldar_wall_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also add an even wider passive aura that applies critical debuffs and intense damage]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Last of three add-ons]]
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/listening_post_upgrade_2_icon]]
GameData["ui_info"]["screen_name_id"] = [[Wall add-on III]]
