...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_khorne_1.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_khorne_1.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Carved with evil runes of death and ruin, the edge of this blade glows with barely-contained power.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The Bloodthirster bound within this mighty axe channels every iota of its hate and rage into these runes until they glow with molten heat.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[The greater the foe the wielder faces, the hotter the runes burn with killing power as the Bloodthirster yearns to battle in the flesh.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 500-833]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_upgrade_angron_other.tga]]
GameData["ui_info"]["screen_name_id"] = [[Skullreaver]]
