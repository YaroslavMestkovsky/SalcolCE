...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_nurgle_3.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_nurgle_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This fabled weapon is the literal manifestation of corruption in its purest form.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The merest scratch from its plague-ridden edge is enough to lay low the hardest foe and can effortlessly overcome even the superhuman resilience of a Space Marine.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 108-200]]
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/corrosive_grenade_research.tga]]
GameData["ui_info"]["screen_name_id"] = [[Corruption]]
