...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_slaanesh_4.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_slaanesh_4.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This gluttonous blade gulps down the souls of its victims before vomiting the stolen energies back into the corporeal body of its wielder.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Its vile soul-greed stems from the starving and deranged Keeper of Secrets bound within ? an arrogant entity that sought to devour enough Eldar souls to challenge the preeminence of Slaanesh himself.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[As punishment for the Daemon's monstrous hubris, Slaanesh trapped it within Soulstealer, condemning the Keeper of Secrets to an eternity of insatiable greed and the hollow existence of a starving slave.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 600-1000]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_upgrade_angron_voidsword.tga]]
GameData["ui_info"]["screen_name_id"] = [[Soulstealer]]
