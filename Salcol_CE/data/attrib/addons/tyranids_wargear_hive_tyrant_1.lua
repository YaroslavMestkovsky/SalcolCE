...
GameData["requirements"]["required_3"]["mutually_exclusive_with"] = [[addons\tyranids_ht_bw_addon.lua]]
GameData["requirements"]["required_4"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_4"]["mutually_exclusive_with"] = [[addons\tyranids_ht_dvh_addon.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Melee weapon choice that takes the upper limbs position]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Deals great amount of damages against armored vehicles and buildings.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Infantry takes slightly less damage]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 183-283]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_scyth.TGA]]
GameData["ui_info"]["screen_name_id"] = [[Crushing claws]]
