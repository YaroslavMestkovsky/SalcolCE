...
GameData["ui_info"]["help_text_list"]["text_02"] = [[Main -          Missile battery]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Lateral -      Twin linked lascannon]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Additional - /]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[]]
GameData["ui_info"]["icon_name"] = [[space_marine_icons/land_raider_helios_icon]]
GameData["ui_info"]["screen_name_id"] = [[Weapon set: Helios]]
