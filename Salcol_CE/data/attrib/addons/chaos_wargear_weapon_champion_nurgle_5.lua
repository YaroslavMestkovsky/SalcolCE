...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_nurgle_4.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_nurgle_4.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Duke Olaks was once a proud leader of an ancient people who foolishly ordered his scientists to formulate an elixir to make him immortal.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[It was with great delight that Nurgle bestowed upon him a terrible wasting sickness for his arrogance.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[So torturous was the incurable contagion?s effect on the duke's undying body that Olaks demanded his scientists develop an antidote to the elixir so that death could finally free him from his eternal torment.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[Though they dutifully succeeded in this venture, Nurgle was far from finished with his newest plaything.]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[Duke Olaks' head now serves as a potent weapon that can be cast among the Lord of Decay?s enemies to spread the very same plague that once afflicted its long-dead owner.]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[DPS: 250-500]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_jones.tga]]
GameData["ui_info"]["screen_name_id"] = [[Death's Head of Duke Olaks]]
