...
GameData["requirements"]["required_4"]["addon"] = [[addons\addon_daemons_army_of_nurgle.lua]]
...
GameData["requirements"]["required_5"]["research_name"] = [[daemons_mark_tzeentch]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Stipulate daemonic contracts with other Nurgle believers in order to obtain their services]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[This relationship will allow to imbue Nurgle units with the Warp energies inside of this building]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Moreover, increase the summoning speed of Nurgle creatures by 10%]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/nurgle_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Nurgle]]
