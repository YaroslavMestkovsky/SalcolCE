...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_slaanesh_1.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_slaanesh_1.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This pair of lashing whips was forged from the agonized screams of a thousand victims.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Each prehensile thong is tipped with a cruel, lacerating hook and is able to deliver excruciating trauma with the slightest touch.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Slaanesh grants these fiendish lashes to an alluress whose murderous deeds have drawn his gaze.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[From atop her speeding chariot, this dark mistress gifts wicked torment to those unfortunate enough to know the sickening pleasure of the whips' touch.]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[DPS: 360-450]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_upgrade_angron_sickle.tga]]
GameData["ui_info"]["screen_name_id"] = [[Whips of agony]]
