...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Berserker Glaive contains the bound essence of a Bloodletter, which has been driven truly insane by its captivity, forcing the bearer to constantly fight with it to remain in control.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[The Glaive transfers this rage to the wielder, who is automatically gripped with "blood frenzy," granting them great strength and resilience.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[However the weapon has no concern over whose life is taken, including any allies and even the wielders themselves, as long as the blood flows in the name of Khorne.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 127-159]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/upgrade_chain_fist.tga]]
GameData["ui_info"]["screen_name_id"] = [[Berzerker glaive]]
