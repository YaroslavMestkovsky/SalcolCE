...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This incorporeal blade inflicts no harm upon its victim's physical body, instead carving its way through the stuff of his very soul.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[So ephemeral and unreal is this strange weapon that it is impossible to cross blades with Soul Bane, for its ghostly edge will pass straight through any guard, in evasion lies the only chance of survival.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Those struck by Soul Bane collapse in agony, writhing and screaming as their lacerated souls slowly bleed away into the ether from out of their unmarked flesh and undamaged armour.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 400-700]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_upgrade_angron_sickle.tga]]
GameData["ui_info"]["screen_name_id"] = [[Soul Bane]]
