...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Formed from the essence of a Keeper of Secrets, this claw has taken many guises and been bound to the flesh of countless of the Dark Prince's Daemons over the millennia.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[When the Slothful Claw strikes, the blow appears clumsy and ponderous to its victim.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[This is but an illusion, in truth the claw strikes like lightning while the foe reels in sluggish confusion.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[DPS: 110-135]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/upgrade_chain_fist.tga]]
GameData["ui_info"]["screen_name_id"] = [[Slothful claw]]
