...
GameData["requirements"]["required_3"]["mutually_exclusive_with"] = [[addons\addon_daemons_army_of_slaanesh.lua]]
GameData["requirements"]["required_4"] = Reference([[requirements\required_addon_cap]])
GameData["requirements"]["required_4"]["addon"] = [[addons\addon_daemons_army_of_tzeentch.lua]]
...
GameData["requirements"]["required_5"]["research_name"] = [[daemons_mark_nurgle]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Stipulate daemonic contracts with other Tzeentch believers in order to obtain their services]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[This relationship will allow to imbue Tzeentch units with the Warp energies inside of this building]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Moreover, increase the summoning speed of Tzeentch creatures by 10%]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/tzeentch_icon]]
GameData["ui_info"]["screen_name_id"] = [[Army of Tzeentch]]
