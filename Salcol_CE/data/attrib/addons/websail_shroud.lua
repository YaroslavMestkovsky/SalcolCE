...
GameData["requirements"]["required_2"]["mutually_exclusive_with"] = [[addons/websail_healing.lua]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Shrouds minor buildings only (Listening Post, Generator, Support Platform, Webway Gates, Minefields)]]
