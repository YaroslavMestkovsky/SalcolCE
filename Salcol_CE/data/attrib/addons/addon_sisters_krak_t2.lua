...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16111181]] -- - Increases the health of the Ecclesiarchal Palace and enable the main defense weapons.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16111182]] -- - Allows to further upgrade the Ecclesiarchal Palace with a Conflagration Emplacement or an Auspex Probe.
GameData["ui_info"]["icon_name"] = [[sisters_icons\building_citadel_upgrade_icon]]
GameData["ui_info"]["screen_name_id"] = [[$16111180]] -- Fortified Palace Walls Add-On
