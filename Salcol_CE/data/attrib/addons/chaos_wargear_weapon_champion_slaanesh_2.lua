...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_slaanesh_7.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_slaanesh_7.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Lash of Torment is a Daemon Weapon wielded by Lucius the Eternal.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[While roaming the dreamscape of the Daemon world Moerpho, Lucius tracked down and killed a trio of Fiends of Slaanesh.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Before their corpses faded into nothingness, he tore out the long and supple tongues of the daemonic beasts and fused them to his grip with a ritual of binding.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[From these loathsome organs, Lucius has fashioned a whip that writhes with a sentience of its own, ensnaring his foes and rasping their flesh from their bones as Lucius goes about his bloody work.]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[DPS: 540-660]]
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_upgrade_angron_sickle.tga]]
GameData["ui_info"]["screen_name_id"] = [[Lash of torment]]
