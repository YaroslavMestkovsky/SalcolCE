...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_khorne_4.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_khorne_4.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[The Axe of Khorne is a Chaos Daemon Weapon which has been imbued with the power and bloodlust of Khorne, driving the bearer to greater feats of death and destruction.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[It is the main weapon used by Bloodthirsters, but on occasion can be gifted to mortal Champions of Khorne who have proved themselves worthy.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 267-333]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_wargear02.tga]]
GameData["ui_info"]["screen_name_id"] = [[Axe of Khorne]]
