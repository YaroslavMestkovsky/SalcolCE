...
GameData["ui_info"]["help_text_list"]["text_01"] = [[To hear the grim tolling of this great bell upon the winds is a death sentence, for its chime heralds the arrival of Nurgle's plague hordes.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Such is its dread power that a single tolling of the Doomsday Bell reverberates for long minutes, spreading dread and despair even over the clangor of battle.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 10-10]]
GameData["ui_info"]["icon_name"] = [[chaos_icons/chapel_doors.tga]]
GameData["ui_info"]["screen_name_id"] = [[Doomsday Bell]]
