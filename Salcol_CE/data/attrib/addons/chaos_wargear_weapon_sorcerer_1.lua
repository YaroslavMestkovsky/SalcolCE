...
GameData["requirements"]["required_2"]["mutually_exclusive_with"] = [[addons\chaos_wargear_weapon_sorcerer_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[This weapon can hurl sorcerous blasts against foes.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[DPS: 68-135]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[]]
GameData["ui_info"]["icon_name"] = [[inquisition_icons/tome_daemonica_1_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Deathscreamer]]
