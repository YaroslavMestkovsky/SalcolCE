...
GameData["modifiers"]["modifier_02"]["value"] = 850
...
GameData["modifiers"]["modifier_07"] = Reference([[modifiers\population_growth_rate_player_modifier.lua]])
GameData["modifiers"]["modifier_07"]["shield_of_faith"] = false
GameData["modifiers"]["modifier_07"]["value"] = 0.1199999973
...
GameData["requirements"]["required_8"]["addon_name"] = [[addons\addon_daemons_list_post_3.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[Further increase the listening post's resistence and requisition/relic income.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Also all nearby buildings will passively regenerate health at a slow rate.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[Overall requisition and power incomes will receive a small debuff. (-8 every 10 seconds)]]
...
GameData["ui_info"]["screen_name_id"] = [[Supreme Dark Channeling add-on]]
