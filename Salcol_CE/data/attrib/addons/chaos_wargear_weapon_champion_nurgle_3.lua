...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_nurgle_1.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\chaos_wargear_weapon_champion_nurgle_1.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[So prolific are the daemon-bacteria infesting this plague-flail that the body of any foe struck down by its filth-encrusted barbs swells into a quivering, pus-bloated blister, before bursting among its kin in a spray of deadly contagions.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[Thus can dozens of foes succumb to a single swing of Epidemia.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[DPS: 50-100]]
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/research_poisoned_blades_icon.tga]]
GameData["ui_info"]["screen_name_id"] = [[Epidemia]]
