...
GameData["ui_info"]["help_text_list"]["text_04"] = [[- Causes minor bleeding with each hit]]
...
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/warp_beast_icon.tga]]
...
GameData["ui_info"]["screen_name_id"] = [[Overgrown spikes of Khorne]]
