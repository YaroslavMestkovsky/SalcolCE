...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"] = Reference([[modifiers\sight_radius_modifier]])
...
GameData["fired_projectile"] = [[tyranids_corrosive_toxin_turret_research]]
