...
GameData["cost"]["cost"]["requisition"] = 320
GameData["cost"]["cost"]["souls"] = 0
GameData["cost"]["time_seconds"] = 10
GameData["death_motion_value"] = [[]]
GameData["fire_cone_angle"] = 5
GameData["fire_cost"] = Reference([[tables\cost_table.lua]])
GameData["fired_projectile"] = [[sm_double_missile_artillery]]
...
GameData["ui_info"]["help_text_list"]["text_07"] = [[Replace part of the missile launcher system with a Whirlwind MK2's allowing to launch additional hybrid missiles]]
