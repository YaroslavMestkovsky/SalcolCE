...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[unit_ability_fx/bolt_of_change_impact]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\enable_squad_voice.lua]])
