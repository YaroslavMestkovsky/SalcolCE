...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Mostly effective against all structures]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Reduces the target's armour and causes little overtime damage]]
...
GameData["ui_info"]["screen_name_id"] = [[Corrosive touch]]
