...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 586
...
GameData["requirements"]["required_1"]["research_name"] = [[research\guard_research_sentinel_armor_2.lua]]
