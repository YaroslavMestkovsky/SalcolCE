...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["squad_table"]["squad_04"] = [[races\inquisition_daemonhunt\inquisition_squad_warhound_vengence_titan.lua]]
