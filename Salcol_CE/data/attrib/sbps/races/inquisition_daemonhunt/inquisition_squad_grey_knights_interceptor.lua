...
GameData["squad_leader_ext"]["leader_2"]["leader"]["type"] = [[ebps\races\inquisition_daemonhunt\troops\inquisition_grey_knights_apothecary.lua]]
...
GameData["squad_requirement_ext"]["requirements"]["required_5"]["research_name"] = [[research\inquisition_daemonhunter_1.rgd]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16021144]] -- - Durability: 4.5 | Strength: 7 | Morale: 6 | Upgrades: 3 | Squad Size: Standard | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 1 | Weapon range: Standard | Capture Points: Yes.
