...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011907]] -- - Durability: Good | Strength: Average | Squad Size: Single | Upgrades: Hero Wargear | Morale: Average | Movement Speed: Slow | Sight: Good | Keen Sight: 2m | Abilities: Below Average | Weapon range: Long | Capture Points: No.
