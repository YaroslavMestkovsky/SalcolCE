...
GameData["squad_leader_ext"]["leader_1"]["cost_time"]["cost"]["requisition"] = 200
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011932]] -- - Improved melee unit (detector). ~~~ Can vault over impassable terrain; roots infantry units by a chance when hit; regenerates quickly.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011933]] -- - Durability: Very Good | Strength: Good | Squad Size: Standard | Upgrades: None | Morale: Very Good | Movement Speed: Very Fast | Sight: Very Good | Keen Sight: 20m | Abilities: Below Average | Weapon range: Standard | Capture Points: Yes.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011934]] -- 
