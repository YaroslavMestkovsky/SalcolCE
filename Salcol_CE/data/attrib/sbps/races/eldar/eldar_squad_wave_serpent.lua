...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011374]] -- - Durability: Average | Strength: Average | Morale: Basic | Upgrades: A lot | Squad Size: Single | Movement Speed: Fast | Sight: Good | Keen Sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011375]] -- 
