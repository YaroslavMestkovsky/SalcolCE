...
GameData["squad_leader_ext"]["leader_1"]["cost_time"]["cost"]["power"] = 175
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18012324]] -- - Durability: Average | Strength: Average | Morale: Immune | Upgrades: Couple + Hero Research | Squad Size: Average | Movement Speed: Lightning Fast | Sight: Good | Keen Sight: None | Abilities: Average | Weapon range: Standard | Capture Points: Uncapture.
