...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011314]] -- - Leader unit (detector). ~~~ Able to provide morale increments and faster ability recharge rates to the squad | if fully upgraded, will be able to use good abilities and provide fortune to the attached squad.
