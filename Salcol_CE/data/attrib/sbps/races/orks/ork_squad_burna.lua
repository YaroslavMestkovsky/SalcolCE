...
GameData["squad_requirement_ext"]["requirements"]["required_10"]["research_name"] = [[research\ork_research_tech_burna_boyz.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011570]] -- - Pre-elite anti-commander unit.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010006]] -- - Effective versus: Commanders
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010015]] -- - Effective versus: Morale
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[- Equipped with kustom skorchas, special burnaz best against enemy nobz.]]
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011571]] -- - Durability: Basic | Strength: Average | Morale: Basic | Upgrades: None | Squad Size: Large | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Abilities: Below Average | Weapon range: Short | Capture Points: Yes.
