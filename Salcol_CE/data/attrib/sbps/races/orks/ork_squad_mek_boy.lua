...
GameData["squad_cannibalize_ext"]["ui_description"] = [[Loot the body of the enemy searching for trophies, technology and skullz alike]]
GameData["squad_cannibalize_ext"]["ui_hotkey"] = [[hotkey_c]]
GameData["squad_cannibalize_ext"]["ui_icon_name"] = [[ork_icons/research_tankbusta_infiltrate.tga]]
GameData["squad_cannibalize_ext"]["ui_title"] = [[Loot remains]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011556]] -- - Durability: Average | Strength: Average | Morale: Average | Upgrades: Hero Wargear | Squad Size: Single | Movement Speed: Standard | Sight: Good | Keen Sight: 15m | Abilities: Average | Weapon range: Short | Capture Points: No.
