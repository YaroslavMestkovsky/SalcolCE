...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[- Elite vehicle unit. ~~~ Exchanges damage for a longer range and accurate weaponry.]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[- Effective Versus: Aircraft.]]
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$18011515]] -- - Durability: Good | Strength: Good | Squad Size: Single | Upgrades: A lot | Morale: Immune | Movement Speed: Fast | Sight: Good | Keen Sight: None | Abilities: Below Average | Weapon range: High-Medium | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_lemanruss_vanquisher]]
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[Leman Russ Vanquisher]]
