...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[- Elite vehicle unit. ~~~ Exchanges damage for 100% accuracy, never misses.]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011519]] -- - Durability: Good | Strength: Good | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Fast | Sight: Good | Keen Sight: None | Abilities: Average | Weapon range: Medium | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[guard_icons/guard_squad_lemanruss_conqueror]]
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[Leman Russ Conqueror]]
