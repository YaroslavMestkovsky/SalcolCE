...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012081]] -- - Durability: Good | Strength: Good | Morale: Immune | Upgrades: Few | Squad Size: Single | Movement Speed: Fast | Sight: Very Good | Keen Sight: None | Abilities: Below Average | Weapon range: Very Long | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[- Zishan (donator of $5) ~~~ For the Imperial Guard, attack!]]
