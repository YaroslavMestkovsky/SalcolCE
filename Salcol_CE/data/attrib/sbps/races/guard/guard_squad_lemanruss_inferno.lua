...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[- Elite vehicle unit. ~~~ Equipped with full fledge flamers.]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011864]] -- - Durability: Good | Strength: Good | Squad Size: Single | Upgrades: None | Morale: Immune | Movement Speed: Fast | Sight: Good | Keen Sight: None | Abilities: Below Average | Weapon range: Short | Capture Points: No.
