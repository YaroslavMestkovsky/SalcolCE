...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18010027]] -- - Durability: Good | Strength: Average | Morale: Good | Upgrades: None | Squad Size: Below standard | Movement Speed: Slow | Sight: Standard |  Keen sight: 2m | Abilities: Below Average | Weapon Range: Melee | Capture Points: No | Reassembling Chance: 30% (65% max).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[- Necron units cannot automatically reassemble as long as their morale is broken]]
