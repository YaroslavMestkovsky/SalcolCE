...
GameData["squad_jump_ext"]["charge_jump_cost_min"] = 300
...
GameData["squad_morale_ext"]["rate_per_second"] = 18
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18012182]] -- - Durability: Excellent | Strength: Very Good | Squad Size: Single | Upgrades: None | Morale: Nearly Unbreakable | Movement Speed: Fast | Sight: Excellent | Keen Sight: 2m | Abilities: Good| Weapon range: Standard | Capture Points: No | Reassembling Chance: 0% (100% max).
