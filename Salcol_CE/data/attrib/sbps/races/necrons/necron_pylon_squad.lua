...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18010012]] -- - Effective versus: Titans
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$18011042]] -- - Durability: Very Excellent | Strength: Legendary | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: (Teleportation) | Sight: Very Good |  Keen sight: None | Abilities: Below Average | Weapon range: Extreme | Capture Points: No.
