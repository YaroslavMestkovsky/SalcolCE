...
GameData["squad_possess_enemy_ext"]["target_filter_table"]["entry_01"] = Reference([[type_armour\tp_armour.lua]])
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011023]] -- - Durability: Good | Strength: Average | Morale: Nearly Unbreakable | Upgrades: Artifacts, Possession, Hero Wargear | Squad Size: Single | Movement Speed: Fast | Sight: Good |  Keen sight: 2m | Abilities: Excellent| Weapon range: Short | Capture Points: No.
