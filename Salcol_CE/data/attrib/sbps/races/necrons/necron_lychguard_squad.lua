...
GameData["squad_jump_ext"]["breakdown_time"] = 1.799999952
...
GameData["squad_jump_ext"]["ui_description"] = [[Teleport directly to a Mobile Obelisk, Restored Monolith, Siege Monolith or Doomsday Monolith]]
...
GameData["squad_reinforce_ext"]["cost"]["cost"]["power"] = 340
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[- (Deepstrike) Heavy Elite melee unit (detector). ~~~ Able to teleport at will; regenerates health more rapidly than any infantry, especially in combat]]
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18010016]] -- - Effective versus: All
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[- Their ranged damage mitigation grows with each Lychguard boost research]]
