...
GameData["squad_jump_ext"]["breakdown_time"] = 3
...
GameData["squad_jump_ext"]["charge_starting_fraction"] = 0
GameData["squad_jump_ext"]["combat_enabled"] = false
GameData["squad_jump_ext"]["jump_distance_max"] = 900
...
GameData["squad_jump_ext"]["ui_description"] = [[After a delay, teleport to the target medium or heavily armored building. On arrival, this unit is briefly immobile.]]
...
GameData["squad_morale_ext"]["broken_modifiers"]["modifier_14"] = Reference([[modifiers\health_get_back_up_modifier.lua]])
...
GameData["squad_morale_ext"]["broken_modifiers"]["modifier_14"]["value"] = 0
...
GameData["squad_requirement_ext"]["requirements"]["required_4"]["max_cumulative_squad_cap"] = 4
...
GameData["squad_requirement_ext"]["requirements"]["required_4"]["squad_table"]["squad_05"] = nil
GameData["squad_requirement_ext"]["requirements"]["required_4"]["squad_table"]["squad_06"] = nil
GameData["squad_requirement_ext"]["requirements"]["required_4"]["squad_table"]["squad_07"] = nil
GameData["squad_requirement_ext"]["requirements"]["required_4"]["squad_table"]["squad_08"] = nil
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011015]] -- - Elite sniper ranged unit. ~~~ Able to be recalled back to structures; weakens armor with every ranged attack.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$18011016]] -- - Durability: Very Good | Strength: Good | Morale: Very Good | Upgrades: None | Squad Size: Small | Movement Speed: Below Standard | Sight: Excellent |  Keen sight: 2m | Abilities: Average | Weapon range: Very long | Capture Points: No | Reassembling Chance: 30% (65% max).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_08"] = [[- Necron units cannot automatically reassemble as long as their morale is broken]]
