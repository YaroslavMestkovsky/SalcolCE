...
GameData["squad_fear_ext"]["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 600
...
GameData["squad_jump_ext"]["requirements"]["required_2"] = Reference([[requirements\required_structure.lua]])
GameData["squad_jump_ext"]["requirements"]["required_2"]["is_display_requirement"] = true 
GameData["squad_jump_ext"]["requirements"]["required_2"]["structure_name"] = [[ebps\races\necrons\structures\monolith.lua]]
...
GameData["squad_morale_ext"]["default"] = 1250
GameData["squad_morale_ext"]["max"] = 1250
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011019]] -- - (Reassembles) Primary commander unit (shrouder (infiltration)). ~~~ Can teleport; can ascend into the Nightbringer.
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011020]] -- - Durability: Good | Strength: Good | Morale: Excellent | Upgrades: Artifacts, Possession, Hero Wargear | Squad Size: Single | Movement Speed: Standard | Sight: Good |  Keen sight: 2m | Abilities: Excellent| Weapon range: Short | Capture Points: No.
