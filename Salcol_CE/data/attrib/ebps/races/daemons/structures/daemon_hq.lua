...
GameData["modifier_apply_ext"]["modifiers_immediate"]["modifier_04"]["value"] = 450
...
GameData["modifier_apply_ext"]["modifiers_immediate"]["modifier_05"]["value"] = 200
...
GameData["research_ext"]["research_table"]["research_05"] = [[research\daemons_research_gift9.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16000012]] -- - Produces: Lost Souls, Furies, Daemon Lord and stature, Shadow Fiends and stature, and mark specific Heralds.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16000013]] -- - Protect every headquarters structure at all costs. For without one, the race will deteriorate!
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16000014]] -- - Able to be upgraded with Hell Fire (limit: 1), and cast warp portals to bring forth an army from one location onto the next!
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16000015]] -- - Able to tier the faction up to tier 5 at a greater cost, but at a fast rate compared to all other races.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$16000016]] -- - Can detect infiltrated units.
