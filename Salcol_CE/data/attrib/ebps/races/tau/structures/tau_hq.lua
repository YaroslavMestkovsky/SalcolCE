...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[- Provides research for stealth suits and basic infantry.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[- Can tier the faction to the highest tier (tier 4) and upgrade the relic resource.]]
