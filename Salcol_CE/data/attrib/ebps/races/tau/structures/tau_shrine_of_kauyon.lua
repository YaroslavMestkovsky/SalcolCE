...
GameData["research_ext"]["research_table"]["research_04"] = [[research\tau_targeting_optics_kroot_melee.lua]]
GameData["research_ext"]["research_table"]["research_05"] = [[research\tau_kroot_pact_research.lua]]
GameData["research_ext"]["research_table"]["research_06"] = [[research\tau_kroot_pact_research_2.lua]]
...
GameData["ui_ext"]["ui_hotkey_name"] = [[tau_kauyon_command_post]]
GameData["ui_ext"]["ui_index_hint"] = 7
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[- Allows units: Kroot Hounds, Krootox, Remora Stealth Drones, Alpha Knarloc Rider, Drone Harbingers, and Orca Transports.]]
