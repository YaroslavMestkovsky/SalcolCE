...
GameData["requirement_ext"]["requirements"]["required_4"]["structure_name"] = [[ebps\races\tau\structures\tau_research_building.lua]]
...
GameData["spawner_ext"]["squad_table"]["squad_10"] = [[sbps\races\tau\tau_kroot_shaper_squad.lua]]
