...
GameData["ui_ext"]["ui_hotkey_name"] = [[tau_shield_generator]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[- Enemies within the shield do not receive any damage protection]]
