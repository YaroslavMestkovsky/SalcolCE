...
GameData["research_ext"]["research_table"]["research_05"] = [[research\eldar_bonesinger_ability_research_3.lua]]
GameData["research_ext"]["research_table"]["research_07"] = [[research\eldar_fleet_of_foot_research.lua]]
GameData["research_ext"]["research_table"]["research_08"] = [[research\all_squad_unit_cap_1.lua]]
...
GameData["research_ext"]["research_table"]["research_11"] = [[research\all_squad_unit_cap_1.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18112300]] -- - Produces: Bonesingers, Storm Guardians, Guardian Defenders, Corsairs, Warlocks, and Seer Council.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[- Operates like a Webway Gate, holding squads inside the Webway Assembly and provides Webway Gate support abilities.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[- Can tier the faction to the highest tier (tier 5) and upgrade the relic resource.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[- Upon tier 4, the HQ can then unleash the Soulstone Superweapon that annihilates living metal and titan like units. Long recharge period.]]
