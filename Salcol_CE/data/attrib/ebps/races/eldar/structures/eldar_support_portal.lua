...
GameData["research_ext"]["research_table"]["research_01"] = [[research\eldar_research_nightwing_regen.lua]]
GameData["research_ext"]["research_table"]["research_02"] = [[research\eldar_gravitic_booster_research.lua]]
GameData["research_ext"]["research_table"]["research_03"] = [[research\eldar_vehicle_ability_research.lua]]
GameData["research_ext"]["research_table"]["research_04"] = [[research\eldar_vehicle_ability_research_2.lua]]
GameData["research_ext"]["research_table"]["research_05"] = [[research\eldar_vehicle_ability_research_3.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18112306]] -- - Produces: Wave Serpents, Falcon Grav Tanks, Vypers, Nightwings, Wraithlords, War Walkers, Night Spinners, Fire Prisms, Soulwalkers.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[- Contains research that provides bonuses to all vehicles.]]
