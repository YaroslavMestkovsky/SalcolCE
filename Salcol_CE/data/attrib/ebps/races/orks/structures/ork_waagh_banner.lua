...
GameData["addon_ext"]["addons"]["addon_04"] = [[addons\ork_ammo_runt_addon.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[- Also Increases support cap and increases the health of all Waagh! Banners by 10% each.]]
