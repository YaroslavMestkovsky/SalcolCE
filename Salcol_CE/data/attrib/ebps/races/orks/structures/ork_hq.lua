...
GameData["addon_ext"]["addons"]["addon_02"] = [[addons\ork_ammo_runt_addon.lua]]
...
GameData["research_ext"]["research_table"]["research_10"] = [[research\all_squad_unit_cap_1.lua]]
GameData["research_ext"]["research_table"]["research_12"] = [[research\ork_research_grot_infiltrate.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18112330]] -- - Produces: Gretchinz, Grot Gangs, Gretchin Tanks, Mad Doks, and the Warboss.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[- Can be upgraded to Orky Fort that allows the production of Grot Tanks, Mad Doks, and the Warboss. Also applies two more defensive placements with extra health bonuses.]]
