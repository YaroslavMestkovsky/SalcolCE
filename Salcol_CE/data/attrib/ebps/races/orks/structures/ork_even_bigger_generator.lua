...
GameData["ability_ext"]["abilities"]["ability_05"] = [[abilities\ork_even_bigger_generator_radiation.lua]]
GameData["ability_ext"]["abilities"]["ability_06"] = [[abilities\ork_even_bigger_generator_bonus.lua]]
...
GameData["death_explosion_ext"]["death_explosions"]["death_explosion_01"]["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_16"]["armour_piercing_value"] = 3
...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Orks/Structures/even_bigger_generator]]
...
GameData["ui_ext"]["ui_hotkey_name"] = [[ork_even_bigga_meanest_generator]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18211643]] -- - Increases the health and damage of all Ork vehicles and titans by 20% (stackable effects).
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18211644]] -- - Increases the production rates and requisition garrisson of all surrounding structures by 30%.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18211645]] -- - WARNING!!! Radiation leak... all nearby infantry will lose health over time if next to the generator.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18211152]] -- - WARNING!!! Extremely volatile and will blow at the destructive force of a lethal EMP, almost destroying all nearby structures and vehicles within a 35 meter radius.
