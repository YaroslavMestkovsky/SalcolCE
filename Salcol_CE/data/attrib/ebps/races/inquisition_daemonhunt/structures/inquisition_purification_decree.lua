...
GameData["requirement_ext"]["requirements"]["required_8"]["structure_name_either"] = nil
GameData["requirement_ext"]["requirements"]["required_8"]["structure_name_or"] = nil
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16020112]] -- - Anti daemon/commander weapon which slows down all nearbye enemies within a 50 meter radius + with upgrades applied.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16020113]] -- - Can harm monstrous creatures and commanders by decreasing their overall morale over time.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16020120]] -- - Has no affect on non monstrous creatures.
