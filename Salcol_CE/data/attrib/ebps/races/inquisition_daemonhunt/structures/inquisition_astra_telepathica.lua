...
GameData["ui_ext"]["ui_hotkey_name"] = [[inquisition_astra_telepathica]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16020062]] -- - Produces: Deployable Turrets, Thunderfire Cannons, Land Speeder Tempest, Vulture Gunship, Valkyrie Transport, and Stormraven Fury.
...
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[Astra telepathica (Tier II)]]
