...
GameData["modifier_apply_ext"]["modifiers"]["modifier_06"] = Reference([[modifiers\cost_requisition_modifier.lua]])
GameData["modifier_apply_ext"]["modifiers"]["modifier_06"]["shield_of_faith"] = false
GameData["modifier_apply_ext"]["modifiers"]["modifier_06"]["target_type_name"] = [[sisters_shrine_to_the_emperor]]
GameData["modifier_apply_ext"]["modifiers"]["modifier_06"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_addition.lua]])
GameData["modifier_apply_ext"]["modifiers"]["modifier_06"]["value"] = -600
GameData["modifier_apply_ext"]["modifiers"]["modifier_07"] = Reference([[modifiers\cost_power_modifier.lua]])
GameData["modifier_apply_ext"]["modifiers"]["modifier_07"]["shield_of_faith"] = false
GameData["modifier_apply_ext"]["modifiers"]["modifier_07"]["target_type_name"] = [[sisters_shrine_to_the_emperor]]
GameData["modifier_apply_ext"]["modifiers"]["modifier_07"]["usage_type"] = Reference([[type_modifierusagetype\tp_mod_usage_addition.lua]])
GameData["modifier_apply_ext"]["modifiers"]["modifier_07"]["value"] = -600
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16111081]] -- - Generates the Power resource at a higher rate than Plasma Generators.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16111082]] -- - Can only be built on top of Slag Deposits.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16111083]] -- - Thermo Plasma Generators are volatile and will damage anything nearby when they are destroyed.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16111084]] -- - Projects a Control Area around itself, allowing other buildings to be built near it.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16111085]] -- - Contains abilities that will greatly fortify your economy and amplify the strength of titans and super structures.
GameData["ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/building_thermo_plasma]]
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$16111080]] -- Thermo Plasma Generator
