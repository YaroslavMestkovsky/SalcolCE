...
GameData["ui_ext"]["ui_hotkey_name"] = [[sisters_missle_silo]]
GameData["ui_ext"]["ui_index_hint"] = 8
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16111161]] -- - Superweapon Structure for the Sisters of Battle.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16111162]] -- - Conceals a missile within the bunker, ready to annihilate the enemies of the Ecclesiarchy.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16111163]] -- - High priority target which is revealed to enemy radars when built.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16111164]] -- - Becomes more expensive with each Missile Silo built.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16111165]] -- - Unlocks the Tier V research.
GameData["ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/building_missile_silo_icon]]
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$16111160]] -- Missile Silo
