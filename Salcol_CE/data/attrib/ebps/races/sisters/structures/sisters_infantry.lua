...
GameData["spawner_ext"]["squad_table"]["squad_10"] = [[sbps\races\sisters\sisters_squad_arco_flagellants.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16111091]] -- - Requisitions infantry units.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16111092]] -- - Produces: Battle Sister Squads, Seraphim Squads, Retributor Squads, Celestian Squads, Repentia Squads, Redemptionist Squads, Legatine Squads, the Canoness, and the Preceptor.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16111093]] -- - Unlocks: Inferno Turret and Ecclesiarchal Cathedral Add-on.
GameData["ui_ext"]["ui_info"]["icon_name"] = [[sisters_icons/building_infantry]]
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$16111090]] -- Adepta Sororitas Convent
