...
GameData["ui_ext"]["ui_hotkey_name"] = [[tyranid_digest_pool]]
GameData["ui_ext"]["ui_index_hint"] = 18
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[- Produces the power resource for tyranids]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16025022]] -- - Exudes toxic miasma and synapse.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[- Can also "deepstrike" Ripper Swarm squads into the front lines.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[]]
GameData["ui_ext"]["ui_info"]["icon_name"] = [[tyranids_icons/i_reclamation_pool]]
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[Digest pool]]
