...
GameData["requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\tyranids_apocalypse_research.lua]]
...
GameData["ui_ext"]["ui_hotkey_name"] = [[tyranid_xeno_hive]]
