...
GameData["ui_ext"]["ui_hotkey_name"] = [[tyranid_relic_hive]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16025394]] -- - Exudes toxic miasma and synapse with also another capability of holding units inside, shared around the globe (20 max).
