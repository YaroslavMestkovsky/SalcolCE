...
GameData["ui_ext"]["ui_hotkey_name"] = [[tyranid_capillary_vein]]
GameData["ui_ext"]["ui_index_hint"] = 20
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16025026]] -- - Gifts you +100 requisition upon construction.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16025027]] -- - Allows to build several support addons to fortify the area of harvest.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16025028]] -- - Each Capillary Vein will also improve all squads' reinforce speed.
