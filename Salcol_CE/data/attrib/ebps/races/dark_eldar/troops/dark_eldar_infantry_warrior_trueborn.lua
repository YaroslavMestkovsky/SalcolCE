...
GameData["ui_ext"]["ui_hotkey_name"] = [[dark_eldar_trueborn_warriors]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18012123]] -- - Durability: Good | Strength: Good | Squad Size: Standard | Upgrades: Few | Morale: Average | Movement Speed: Above standard | Sight: Good | Keen Sight: 2m | Abilities: Below Average | Weapon range: Long | Capture Points: Yes.
