...
GameData["spawner_ext"]["squad_table"]["squad_04"] = [[sbps\races\dark_eldar\dark_eldar_squad_slave.lua]]
...
GameData["ui_ext"]["ui_hotkey_name"] = [[dark_eldar_great_kabal_citadel]]
