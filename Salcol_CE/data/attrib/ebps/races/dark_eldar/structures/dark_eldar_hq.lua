...
GameData["ability_ext"]["abilities"]["ability_11"] = [[abilities\dark_eldar_portal_healing2.lua]]
...
GameData["research_ext"]["research_table"]["research_04"] = [[research\dark_eldar_infiltration_mandrake_research.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[- Able to teleport one squad of infantry to any location on the battlefield after a long duration of wait.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[- Can tier the faction to the highest tier (tier 5).]]
