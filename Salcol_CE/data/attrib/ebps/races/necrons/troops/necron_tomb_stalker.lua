...
GameData["ui_ext"]["ui_hotkey_name"] = [[necron_tomb_stalker]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$18011035]] -- - Durability: Very Good | Strength: Very Good | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Standard |  Keen sight: None | Abilities: Below Average | Weapon range: Standard | Capture Points: No | Reassembling Chance: 0% (35% max).
