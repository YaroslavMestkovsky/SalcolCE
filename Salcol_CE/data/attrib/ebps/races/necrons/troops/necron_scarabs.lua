...
GameData["event_manager_ext"]["event_23"]["event_entry_01"]["event_name"] = [[Chaos/Abilities/ps_sorceror]]
...
GameData["melee_ext"]["in_melee_modifiers"]["modifier_01"]["value"] = 0.7200000286
...
GameData["melee_ext"]["in_melee_modifiers"]["modifier_02"]["value"] = 1.25
GameData["melee_ext"]["in_melee_modifiers"]["modifier_03"] = Reference([[modifiers\health_rangedamage_received_1_modifier.lua]])
GameData["melee_ext"]["in_melee_modifiers"]["modifier_03"]["value"] = 0.7200000286
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[- Basic starting swarm melee unit. ~~~ Able to jump over impassable terrain; Can burrow]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[- Able to uncapture enemy strategic locations]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011004]] -- - Durability: Weak | Strength: Basic | Morale: Immune | Upgrades: None | Squad Size: Large | Movement Speed: Very fast | Sight: Short |  Keen sight: 2m | Abilities: Basic | Weapon Range: Melee | Capture Points: No.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[- Laurent Meesters (donator of $1) ~~~ Swarm them.... with death.]]
