...
GameData["ui_ext"]["ui_hotkey_name"] = [[necron_immortals]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011008]] -- - Durability: Good | Strength: Good | Morale: Good | Upgrades: Few | Squad Size: Below standard | Movement Speed: Slow | Sight: Standard |  Keen sight: 2m | Abilities: Below Average | Weapon range: Long | Capture Points: No | Reassembling Chance: 30% (65% max).
