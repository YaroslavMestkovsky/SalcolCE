...
GameData["ui_ext"]["ui_hotkey_name"] = [[necron_builder_scarabs]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18010019]] -- - Builder unit. ~~~ Can burrow underground; able to be recalled back to structures; if a Critical Location is captured, the faction will receive production bonuses applied to all monoliths; shares a limit of 10 with Sentry Pylons (units).
