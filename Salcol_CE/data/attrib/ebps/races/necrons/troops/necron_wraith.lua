...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$18011001]] -- - Durability: Average | Strength: Very Good | Morale: Immune | Upgrades: None | Squad Size: Single | Movement Speed: Fast | Sight: Good |  Keen sight: 20m | Abilities: Basic | Weapon Range: Melee | Capture Points: Uncapture | Reassembling Chance: 5% (40% max).
