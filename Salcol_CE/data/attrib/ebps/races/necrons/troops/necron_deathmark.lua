...
GameData["ui_ext"]["ui_hotkey_name"] = [[necron_deathmarks]]
GameData["ui_ext"]["ui_index_hint"] = 7
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011015]] -- - Elite sniper ranged unit. ~~~ Able to be recalled back to structures; weakens armor with every ranged attack.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$18011016]] -- - Durability: Very Good | Strength: Good | Morale: Very Good | Upgrades: None | Squad Size: Small | Movement Speed: Below Standard | Sight: Excellent |  Keen sight: 2m | Abilities: Average | Weapon range: Very long | Capture Points: No | Reassembling Chance: 30% (65% max).
