...
GameData["ui_ext"]["ui_hotkey_name"] = [[necron_heavy_destroyers]]
GameData["ui_ext"]["ui_index_hint"] = 11
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$18011028]] -- - Heavy ranged infantry. ~~~ Can jump over impassable terrain.
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18011029]] -- - Durability: Good | Strength: Good | Morale: Very Good | Upgrades: None | Squad Size: Small | Movement Speed: Fast | Sight: Standard |  Keen sight: 2m | Abilities: Below Average | Weapon range: Short | Capture Points: No | Reassembling Chance: 20% (55% max).
