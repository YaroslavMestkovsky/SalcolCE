...
GameData["ui_ext"]["ui_hotkey_name"] = [[necron_antient_summoning_core]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$18111450]] -- - Allows the production of the most powerful Necron units and deepstrike them within 100m from structure.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$18111451]] -- - Produces: Death Lord, Mobile Obelisk, Siege Monolith, Doomsday Monolith, Sentry Pylons, Gauss Pylons, and Æonic Orb.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$18111448]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[- Increase the Squad Cap by +6]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[- Increase the Support Cap by +6]]
GameData["ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_ancient_summoning_core_icon]]
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$15043073]] -- Ancient Summoning Core
