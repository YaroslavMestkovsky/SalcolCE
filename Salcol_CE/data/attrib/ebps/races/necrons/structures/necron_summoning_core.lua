...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[- Increase the Squad Cap by +2]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[- Increase the Support Cap by +2]]
