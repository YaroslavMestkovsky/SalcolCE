...
GameData["ability_ext"]["abilities"]["ability_01"] = [[inquisition_xanthite_inquisitor_6_aura.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[inquisition_xanthite_inquisitor_6_aura_daemons.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_id"] = [[$95641]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[Gain the right to install one of the most atrocious decrees]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[In order to cast it, hovewer, all 12 Xanthine cultists must be in 30m radius to provide psichic support.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[When used, a purgation decree is built at the targeted spot. Enemies within the area of effect will be set on fire and will suffer continuous damages]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[Many debuffs are also applied in the meantime.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[The purgation decree also contains additional abilities, addons and researches]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[There can only be 1 purgation decree at a time.]]
GameData["ui_ext"]["ui_info"]["icon_name"] = [[inquisition_icons/purification_decree_icon]]
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[Purgation Decree]]
