...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\dark_eldar_torture_amp_aura_enemy.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\dark_eldar_torture_amp_aura_ally.lua]]
