...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[- A warp pillar which can force nearby enemies to attack each other by a chance.]]
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[- If not destroyed, it will wreck havoc on all nearby foes forever.]]
