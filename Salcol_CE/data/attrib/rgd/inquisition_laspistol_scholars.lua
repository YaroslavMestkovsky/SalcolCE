...
GameData["ui_info"]["help_text_id"] = [[$16021131]] -- - (Deepstrike) Relic unit siege/walker vehicle. ~~~ Can garrisson the Grand Master, tripling its statistics; damages nearby monstrous creatures over time; is protected from melee and ranged attacks with an aura of daemon purge when health is >= 50%.
