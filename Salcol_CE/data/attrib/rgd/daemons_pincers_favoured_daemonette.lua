...
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Has average effectiveness against all armour types]]
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons/officers_weapons_research.tga]]
GameData["ui_info"]["screen_name_id"] = [[Pincer arm]]
